...
1. 在 Issue 下评论表达您的意愿（例如："I'd like to work on this"）
2. 简要描述您的实现思路，以便 Maintainer 提前给出反馈
3. 等待 Maintainer 将 Issue 分配给您 — **在被分配之前请勿开始工作**

#### 认领后的要求

- 在被分配后 **14 天内**提交 PR
- 如果需要更多时间，请在 Issue 中留言说明
- 如果 14 天内没有提交 PR 或更新进展，Issue 可能会被取消分配并重新开放给其他贡献者

#### 提示

- 在认领之前，请先检查 Issue 是否已有 Assignee
- 对于复杂的 Issue，建议先在 Issue 中讨论实现方案再开始
- 如果无法继续完成，可以主动取消认领 — 留言说明即可
