...
class AddressServerClusterControllerTest {
    ...
    void before() {
        mockMvc = MockMvcBuilders.standaloneSetup(
                new AddressServerClusterController(instanceOperator, metadataManager,
                        clusterOperator,
                        new AddressServerManager(), new AddressServerGeneratorManager()))
                .build();
        Service service = Service
                .newService(Constants.DEFAULT_NAMESPACE_ID, Constants.DEFAULT_GROUP,
    ...
    void testPostCluster() throws Exception {
        ...
        mockMvc.perform(post("/nacos/v1/as/nodes").param("product", "default")
    ...
    void testDeleteCluster() throws Exception {
        mockMvc.perform(delete("/nacos/v1/as/nodes").param("product", "default")
                .param("cluster", "serverList")
                .param("ips", "192.168.3.1,192.168.3.2")).andExpect(status().isOk());
    }
