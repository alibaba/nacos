...
/**
 * Shared HTTP fields and JSON parsing for Agent draft creation and Client publication.
 *
 * @author Nacos
 */
public abstract class AbstractAgentDraftForm extends AgentVersionForm {
    ...
    protected AbstractAgentDraftForm() {
    }
    
    /**
     * Validate the form identity and copy parsed fields into a concrete request.
     *
     * @param result concrete request receiving draft content
     * @throws NacosApiException when a JSON field or form identity is invalid
     */
    protected void fillRequest(AbstractAgentDraftRequest result) throws NacosApiException {
        super.validate();
