...
/**
 * HTTP form for querying an exact or latest serving MCP Version.
 *
 * @author Nacos
 */
public class McpQueryForm implements NacosForm {
    ...
    /**
     * Convert this form to the transport-neutral MCP query request.
     *
     * @return MCP query request
     * @throws NacosApiException if the form is invalid
     */
    public QueryMcpServerRequest toRequest() throws NacosApiException {
        ...
        QueryMcpServerRequest result = new QueryMcpServerRequest();
