...
/**
 * Extracts the namespace from a generic or resource-specific AI Search request.
 *
 * @author Nacos
 */
public class AiResourceSearchHttpParamExtractor extends AbstractHttpParamExtractor {
