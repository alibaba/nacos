...
public interface SkillSubscriptionService {
    ...
    /**
     * List current subscriber's skill subscriptions in the namespace.
     *
    ...
    /**
     * Add or update current subscriber's skill subscriptions in the namespace.
     *
     * @param namespaceId    namespace ID
     * @param subscriptions  subscription items
     * @return updated subscription document
     * @throws NacosException if update failed
     */
    SkillSubscriptionDocument subscribe(String namespaceId,
        List<SkillSubscription> subscriptions) throws NacosException;
    
    /**
     * Remove current subscriber's skill subscriptions in the namespace.
     *
     * @param namespaceId namespace ID
