    ...
    public static AgentInterface buildAgentInterface(Instance instance) {
        ...
        agentInterface.setProtocolVersion(
                instance.getMetadata()
                        .get(Constants.A2A.NACOS_AGENT_ENDPOINT_PROTOCOL_VERSION_KEY));
        agentInterface.setTenant(
                instance.getMetadata().get(Constants.A2A.NACOS_AGENT_ENDPOINT_TENANT_KEY));
