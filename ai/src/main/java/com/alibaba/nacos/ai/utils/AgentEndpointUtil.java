...
public class AgentEndpointUtil {
    ...
    public static Instance transferToInstance(AgentEndpoint endpoint) throws NacosApiException {
        ...
        String protocolVersion = StringUtils.isBlank(endpoint.getProtocolVersion()) ? StringUtils.EMPTY
                : endpoint.getProtocolVersion();
        String tenant = StringUtils.isBlank(endpoint.getTenant()) ? StringUtils.EMPTY : endpoint.getTenant();
