...
class McpServerCacheInvalidateServiceTest {
    ...
    private static final String TEST_GROUP_KEY_VERSION = GroupKey.getKey(TEST_DATAID_VERSION,
            Constants.MCP_SERVER_VERSIONS_GROUP, TEST_NAMESPACE);
    ...
    void testHandleEventWithInvalidDataIdFormat() {
        ...
        String groupKey = GroupKey.getKey("invalid-data-id", Constants.MCP_SERVER_VERSIONS_GROUP,
                TEST_NAMESPACE);
        LocalDataChangeEvent event = new LocalDataChangeEvent(groupKey);
