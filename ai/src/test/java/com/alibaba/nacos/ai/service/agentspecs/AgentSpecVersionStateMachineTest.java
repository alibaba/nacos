...
class AgentSpecVersionStateMachineTest {
    ...
    private static List<List<StateMachineOp>> sampleOperationSequences() {
        return Arrays.asList(
                Arrays.asList(StateMachineOp.SUBMIT, StateMachineOp.PUBLISH,
                        StateMachineOp.GO_OFFLINE),
                Arrays.asList(StateMachineOp.SUBMIT, StateMachineOp.PUBLISH,
                        StateMachineOp.GO_OFFLINE,
                        StateMachineOp.GO_ONLINE),
                Arrays.asList(StateMachineOp.PUBLISH, StateMachineOp.SUBMIT,
                        StateMachineOp.GO_ONLINE,
