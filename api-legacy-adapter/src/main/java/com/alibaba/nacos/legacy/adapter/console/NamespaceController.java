...
/**
 * Legacy namespace service (v1/console/namespaces).
 *
 * @author Nacos
 */
@RestController
...
public class NamespaceController {
     ...
     */
    @PostMapping
    @Secured(resource = Constants.Resource.CONSOLE_RESOURCE_NAME_PREFIX + "namespaces", action = ActionTypes.WRITE)
    ...
    /**
     * Check whether namespace id exists.
     *
     * @deprecated This API is deprecated and no longer maintained. Please use the v3 API instead.
     */
