...
/**
 * Legacy Server state controller (v1/console/server).
 *
 * @author xingxuechao on:2019/2/27 11:17 AM
 */
@RestController("legacyConsoleServerStateController")
...
public class ServerStateController {
    ...
    public org.springframework.http.ResponseEntity<Map<String, String>> serverState() {
        return org.springframework.http.ResponseEntity.ok(stateService.getServerState());
    }
