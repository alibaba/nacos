...
/**
 * Legacy cluster communication interface (v1/core/cluster).
 *
...
public class NacosClusterController {
    ...
    /**
     * List cluster nodes with optional keyword filter.
     *
     * @deprecated This API is deprecated and no longer maintained. Please use the v3 API instead.
     */
    ...
    /**
     * Member leave (temporarily not allowed).
     *
     * @deprecated This API is deprecated and no longer maintained. Please use the v3 API instead.
     */
