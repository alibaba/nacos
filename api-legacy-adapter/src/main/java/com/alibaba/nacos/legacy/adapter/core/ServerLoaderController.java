...
package com.alibaba.nacos.legacy.adapter.core;
...
/**
 * Legacy controller to control server loader (v2/core/loader).
 *
 * @author liuzunfei
 */
@RestController
...
public class ServerLoaderController {
    ...
    /**
     * Reload SDK connection count on current server.
     *
     * @deprecated This API is deprecated and no longer maintained. Please use the v3 API instead.
     */
    ...
    /**
     * Smart reload SDK connections across cluster.
     *
     * @deprecated This API is deprecated and no longer maintained. Please use the v3 API instead.
     */
    @Secured(resource = Commons.NACOS_CORE_CONTEXT_V2 + "/loader", action = ActionTypes.WRITE)
    ...
    /**
     * Reload single SDK connection by id.
     *
     * @deprecated This API is deprecated and no longer maintained. Please use the v3 API instead.
     */
    @Secured(resource = Commons.NACOS_CORE_CONTEXT_V2 + "/loader", action = ActionTypes.WRITE)
    ...
    private Map<String, Object> getServerLoadMetrics() {
        ...
        responseMap.put("avg", responseList.isEmpty() ? 0 : total / responseList.size());
        responseMap.put("threshold", responseList.isEmpty() ? 0 : total / responseList.size() * 1.1);
