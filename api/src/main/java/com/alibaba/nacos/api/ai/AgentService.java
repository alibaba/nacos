...
public interface AgentService extends A2aService, AgentDiscoveryService {
     ...
     * {@link AgentPublishClientRequest#isAutoSubmit()} requests the ordinary submit pipeline and never
     ...
     */
    @Since("3.3.0")
    default AgentVersionDetail publishAgent(AgentPublishClientRequest request)
