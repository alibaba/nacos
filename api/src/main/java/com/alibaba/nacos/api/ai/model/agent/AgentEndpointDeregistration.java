 ...
 *
 * <p>The namespace comes from the owning AiService instance. The SDK copies this input
 * before creating its transport request.</p>
 *
 * @author Nacos
 * @since 3.3.0
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class AgentEndpointDeregistration implements Serializable {
