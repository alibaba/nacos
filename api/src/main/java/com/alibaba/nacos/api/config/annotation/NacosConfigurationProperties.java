...
public @interface NacosConfigurationProperties {
    ...
    /**
     * It indicates the properties of current doBind bean is auto-refreshed when Nacos configuration
     * is changed.
     *
    ...
    /**
     * Flag to indicate that when binding to this object invalid fields should be ignored. Invalid
     * means invalid according to the binder that is used, and usually this means fields of the
     * wrong type (or that cannot be coerced into the correct type).
     *
    ...
    /**
     * Flag to indicate that when binding to this object fields with periods in their names should
     * be ignored.
     *
     * @return the flag value (default false)
     */
    ...
    /**
     * Flag to indicate that when binding to this object unknown fields should be ignored. An
     * unknown field could be a sign of a mistake in the Properties.
     *
     ...
     * validation fails. If it is set to false, validation errors will be swallowed. They will be
