...
/**
 * ConfigDraftQueryRequest.
 *
 * @author wss
 * @version $Id: ConfigPublishDraftRequest.java, v 0.1 2021年06月17日 4:59 PM wss Exp $
 */
public class ConfigDraftQueryRequest extends AbstractConfigRequest {
     ...
     * @param group  group
     * @param tenant tenant
     * @return ConfigDraftQueryRequest instance.
     */
    public static ConfigDraftQueryRequest build(String dataId, String group, String tenant) {
        ConfigDraftQueryRequest request = new ConfigDraftQueryRequest();
