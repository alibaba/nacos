 ...
 *
 * @author wss
 * @version $Id: ConfigDraftRequest.java, v 0.1 2021年06月17日 4:59 PM wss Exp $
 */
public class ConfigDraftRequest extends AbstractConfigRequest {
    ...
    public ConfigDraftRequest(String dataId, String group, String tenant, String content) {
