...
/**
 * ConfigPublishDraftRequest.
 *
 * @author wss
 * @version $Id: ConfigPublishDraftRequest.java, v 0.1 2021年06月17日 4:59 PM wss Exp $
 */
public class ConfigPublishDraftRequest extends AbstractConfigRequest {
    ...
    public ConfigPublishDraftRequest() {
    ...
    public ConfigPublishDraftRequest(String dataId, String group, String tenant) {
        this.dataId = dataId;
        this.group = group;
        this.tenant = tenant;
    }
    ...
    /**
     * Getter method for property <tt>additionMap</tt>.
     *
     * @return property value of additionMap
     */
