...
/**
 * ConfigRemoveDraftRequest.
 *
 * @author wss
 * @version $Id: ConfigPublishDraftRequest.java, v 0.1 2021年06月17日 4:59 PM wss Exp $
 */
public class ConfigRemoveDraftRequest extends AbstractConfigRequest {
    ...
    public ConfigRemoveDraftRequest() {

    }

    public ConfigRemoveDraftRequest(String dataId, String group, String tenant, String tag) {
        this.dataId = dataId;
        this.group = group;
        this.tag = tag;
        this.tenant = tenant;
