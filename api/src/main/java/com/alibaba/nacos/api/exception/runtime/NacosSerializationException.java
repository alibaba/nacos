...
import static com.alibaba.nacos.api.common.Constants.Exception.SERIALIZE_DEFAULT_MSG;
import static com.alibaba.nacos.api.common.Constants.Exception.SERIALIZE_ERROR_CODE;
import static com.alibaba.nacos.api.common.Constants.Exception.SERIALIZE_MSG_FOR_SPECIFIED_CLASS;
...
public class NacosSerializationException extends NacosRuntimeException {
    ...
    public NacosSerializationException(Class<?> serializedClass) {
        super(SERIALIZE_ERROR_CODE, String.format(SERIALIZE_MSG_FOR_SPECIFIED_CLASS, serializedClass.getName()));
        this.serializedClass = serializedClass;
    }
    
    public NacosSerializationException(Throwable throwable) {
        super(SERIALIZE_ERROR_CODE, SERIALIZE_DEFAULT_MSG, throwable);
    }
    
    public NacosSerializationException(Class<?> serializedClass, Throwable throwable) {
        super(SERIALIZE_ERROR_CODE, String.format(SERIALIZE_MSG_FOR_SPECIFIED_CLASS, serializedClass.getName()), throwable);
        this.serializedClass = serializedClass;
    }
