...
public final class RequestGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<GrpcRequest, GrpcResponse> getRequestMethod;
  
  @io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/'
          + "request", requestType = GrpcRequest.class, responseType = GrpcResponse.class, methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<GrpcRequest, GrpcResponse> getRequestMethod() {
    ...
    if ((getRequestMethod = RequestGrpc.getRequestMethod) == null) {
      synchronized (RequestGrpc.class) {
        if ((getRequestMethod = RequestGrpc.getRequestMethod) == null) {
          RequestGrpc.getRequestMethod = getRequestMethod = io.grpc.MethodDescriptor.<GrpcRequest, GrpcResponse>newBuilder()
                  .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                  .setFullMethodName(generateFullMethodName("Request", "request")).setSampledToLocalTracing(true)
  ...
  public static abstract class RequestImplBase implements io.grpc.BindableService {
    ...
    public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor()).addMethod(getRequestMethod(),
              asyncUnaryCall(new MethodHandlers<GrpcRequest, GrpcResponse>(this, METHODID_REQUEST))).build();
    }
  }
  ...
  public static final class RequestFutureStub extends io.grpc.stub.AbstractStub<RequestFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<GrpcResponse> request(GrpcRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_REQUEST:
          serviceImpl.request((GrpcRequest) request, (io.grpc.stub.StreamObserver<GrpcResponse>) responseObserver);
          break;
        default:
      ...
      synchronized (RequestGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
                  .setSchemaDescriptor(new RequestFileDescriptorSupplier()).addMethod(getRequestMethod()).build();
        }
      }
    }
    return result;
