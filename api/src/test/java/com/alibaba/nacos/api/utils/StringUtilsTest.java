...
public class StringUtilsTest {
    ...
    public void testRegionMatchesEqualsCaseSensitiveForNonString() {
        Assert.assertTrue(
                StringUtils.regionMatches(new StringBuilder("abc"), false, 0, "xabc", 1, 3));
    }

    @Test
    public void testRegionMatchesEqualsCaseInsensitiveForNonString() {
        Assert.assertTrue(
                StringUtils.regionMatches(new StringBuilder("abc"), true, 0, "xabc", 1, 3));
        Assert.assertTrue(
                StringUtils.regionMatches(new StringBuilder("abc"), true, 0, "xAbc", 1, 3));
    }
    ...
    public void testRegionMatchesNotEqualsCaseSensitiveForNonString() {
        Assert.assertFalse(
                StringUtils.regionMatches(new StringBuilder("abc"), false, 0, "xAbc", 1, 3));
        Assert.assertFalse(
                StringUtils.regionMatches(new StringBuilder("abc"), false, 0, "xCbc", 1, 3));
    }

    @Test
    public void testRegionMatchesNotEqualsCaseInsensitiveForNonString() {
        Assert.assertFalse(
                StringUtils.regionMatches(new StringBuilder("abc"), true, 0, "xCab", 1, 3));
    }
}
