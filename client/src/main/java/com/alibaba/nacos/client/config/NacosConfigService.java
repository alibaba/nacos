...
public class NacosConfigService implements ConfigService {
    ...
    public NacosConfigService(Properties properties) throws NacosException {
        ...
        this.worker =
                new ClientWorker(
                        this.configFilterChainManager, serverListManager, clientProperties);
        // will be deleted in 2.0 later versions
    ...
    public String getConfigAndSignListener(
        ...
        ConfigResponse configResponse =
                worker.getAgent()
                        .queryConfig(
                                dataId, group, worker.getAgent().getTenant(), timeoutMs, false);
        String content = configResponse.getContent();
        String encryptedDataKey = configResponse.getEncryptedDataKey();
        worker.addTenantListenersWithContent(
                dataId, group, content, encryptedDataKey, Arrays.asList(listener));
    ...
    public boolean publishConfigCas(
            ...
            throws NacosException {
        return publishConfigInner(
                namespace, dataId, group, null, null, null, content, type, casMd5);
    }
