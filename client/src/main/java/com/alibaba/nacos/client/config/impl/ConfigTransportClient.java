...
public abstract class ConfigTransportClient {
    ...
    public ConfigTransportClient(
        ...
        this.securityProxy =
                new SecurityProxy(
                        serverListManager.getServerUrls(),
    ...
    protected RequestResource buildResource(String tenant, String group, String dataId) {
        return RequestResource.configBuilder()
                .setNamespace(tenant)
                .setGroup(group)
                .setResource(dataId)
                .build();
    ...
    private void initMaxRetry(Properties properties) {
        maxRetry =
                ConvertUtils.toInt(
                        String.valueOf(properties.get(PropertyKeyConst.MAX_RETRY)),
                        Constants.MAX_RETRY);
    }
     ...
     */
    public abstract ConfigResponse queryConfig(
            String dataId, String group, String tenat, long readTimeous, boolean notify)
     ...
     */
    public abstract boolean publishConfig(
            String dataId,
            String group,
            String tenant,
            String appName,
