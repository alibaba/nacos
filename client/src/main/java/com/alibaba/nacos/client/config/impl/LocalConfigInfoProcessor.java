...
import com.alibaba.nacos.client.utils.CacheDirUtils;
...
public class LocalConfigInfoProcessor {
    ...
    static {
        LOCAL_FILEROOT_PATH =
                System.getProperty("JM.LOG.PATH", CacheDirUtils.getCacheDir()) + File.separator + "nacos"
                        + File.separator + "config";
        LOCAL_SNAPSHOT_PATH =
                System.getProperty("JM.SNAPSHOT.PATH", CacheDirUtils.getCacheDir()) + File.separator + "nacos"
                        + File.separator + "config";
