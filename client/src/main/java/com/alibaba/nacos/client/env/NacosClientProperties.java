...
/**
 * NacosClientProperties interface. include all the properties from jvm args, system environment,
 * default setting. more details you can see https://github.com/alibaba/nacos/issues/8622
 *
 * @author onewe
 */
public interface NacosClientProperties {
    ...
    /**
     * all the NacosClientProperties object must be created by PROTOTYPE, so child
     * NacosClientProperties can read properties from the PROTOTYPE. it looks like this:
     * |-PROTOTYPE----------------> ip=127.0.0.1 |---|-child1---------------> port=6379 if you
     * search key called "port" from child1, certainly you will get 6379 if you search key called
     * "ip" from child1, you will get 127.0.0.1. because the child can read properties from parent
    ...
    /**
     * get property, if the value can not be got by the special key, the default value will be
     * returned.
     *
     * @param key special key
    ...
    /**
     * get boolean, if the value can not be got by the special key, the default value will be
     * returned.
     *
     * @param key special key
     * @param defaultValue default value
    ...
    /**
     * get integer, if the value can not be got by the special key, the default value will be
     * returned.
     *
     * @param key special key
     * @param defaultValue default value
     ...
     * @return true if and only if the specified object is a key in this NacosClientProperties,
     *     false otherwise.
     */
