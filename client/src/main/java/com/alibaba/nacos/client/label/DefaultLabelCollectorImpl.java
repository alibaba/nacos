...
public class DefaultLabelCollectorImpl implements LabelCollector {
    ...
    private Map<String, String> getEnvironments() {
        ...
        String LABEL_SITE = "SIGMA_APP_SITE";
        String site = System.getenv(LABEL_SITE);
        String LABEL_UNIT = "SIGMA_APP_UNIT";
        String unit = System.getenv(LABEL_UNIT);
        String LABEL_APP = "SIGMA_APP_NAME";
        String app = System.getenv(LABEL_APP);
        String LABEL_STAGE = "SIGMA_APP_STAGE";
        String stage = System.getenv(LABEL_STAGE);
