...
public abstract class RedoData<T> {
     ...
     *
     * <ul>
     *   <li>{@code true} meas the cached data expect registered to server finally.
     *   <li>{@code false} means unregistered from server.
     * </ul>
     */
     ...
     *
     * <ul>
     *   <li>{@code registered=true} & {@code unregistering=false} means data has registered, so
     *       redo should not do anything.
     *   <li>{@code registered=true} & {@code unregistering=true} means data has registered and now
     *       need unregister.
     *   <li>{@code registered=false} & {@code unregistering=false} means not registered yet, need
     *       register again.
     *   <li>{@code registered=false} & {@code unregistering=true} means not registered yet and not
    ...
    public boolean equals(Object o) {
        ...
        return registered == redoData.registered
                ...
                && serviceName.equals(redoData.serviceName)
