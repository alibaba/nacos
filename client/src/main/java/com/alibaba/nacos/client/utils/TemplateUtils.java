...
public class TemplateUtils {
    ...
    public static String stringEmptyAndThenExecute(String source, Callable<String> callable) {
        ...
        // return EMPTY or throw an error in catch block
        return StringUtils.isEmpty(source) ? StringUtils.EMPTY : source.trim();
    }
    ...
    public static String stringBlankAndThenExecute(String source, Callable<String> callable) {
        ...
        // return EMPTY or throw an error in catch block
        return StringUtils.isBlank(source) ? StringUtils.EMPTY : source.trim();
    }
}
