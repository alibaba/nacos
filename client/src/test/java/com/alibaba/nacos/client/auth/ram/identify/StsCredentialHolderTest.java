...
public class StsCredentialHolderTest {
    ...
    @Mock private HttpClientRequest mockRest;
    ...
    public void setUp() throws Exception {
        ...
        httpClient =
                (HttpClientRequest)
                        field.get(ConfigHttpClientManager.getInstance().getNacosRestTemplate());
    ...
    @Test
    public void testGetStsCredentialFromCache()
    ...
    public void testGetStsCredentialFromRequest() throws Exception {
        ...
        when(response.getBody())
                .thenReturn(new ByteArrayInputStream(JacksonUtils.toJsonBytes(stsCredential)));
