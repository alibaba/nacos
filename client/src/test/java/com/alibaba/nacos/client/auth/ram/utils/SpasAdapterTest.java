...
public class SpasAdapterTest {
    ...
    public void testSign2() {
        ...
        //  Assert.assertEquals(2, map2.size());
        //  Assert.assertEquals(SpasAdapter.signWithHmacSha1Encrypt("aa" + "+" +
        // map2.get("Timestamp"), "123"),
        //  map2.get("Spas-Signature"));
