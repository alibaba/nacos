...
public class NacosConfigServiceTest {
    ...
    private ClientWorker mockWorker;
    ...
    public void mock() throws Exception {
        ...
        mockWorker = Mockito.mock(ClientWorker.class);
        setFinal(NacosConfigService.class.getDeclaredField("worker"), nacosConfigService, mockWorker);
    }
    ...
    public void testGetConfig() throws NacosException {
        ...
        Mockito.verify(mockWorker, Mockito.times(1)).getServerConfig(dataId, group, tenant, timeout, false);
    ...
    public void testGetConfigAndSignListener() throws NacosException {
        ...
        response.setConfigType("bb");
        Mockito.when(mockWorker.getServerConfig(dataId, group, tenant, timeout, false)).thenReturn(response);
        Mockito.when(mockWorker.getAgentTenant()).thenReturn(tenant);
        ...
        Mockito.verify(mockWorker, Mockito.times(1))
    ...
    public void testAddListener() throws NacosException {
        ...
        Mockito.verify(mockWorker, Mockito.times(1)).addTenantListeners(dataId, group, Arrays.asList(listener));
    }
    ...
    public void testPublishConfig() throws NacosException {
        ...
        Mockito.when(mockWorker.publishConfig(dataId, group, namespace, null, null, null, content, "", null, type))
                .thenReturn(true);
    ...
    public void testPublishConfigCas() throws NacosException {
        ...
        Mockito.when(mockWorker.publishConfig(dataId, group, namespace, null, null, null, content, "", casMd5, type))
                .thenReturn(true);
    ...
    public void testRemoveConfig() throws NacosException {
        ...
        Mockito.when(mockWorker.removeConfig(dataId, group, tenant, null)).thenReturn(true);
        
        final boolean b = nacosConfigService.removeConfig(dataId, group);
        Assert.assertTrue(b);
        
        Mockito.verify(mockWorker, Mockito.times(1)).removeConfig(dataId, group, tenant, null);
    }
    ...
    public void testRemoveListener() {
        ...
        Mockito.verify(mockWorker, Mockito.times(1)).removeTenantListener(dataId, group, listener);
    }
    
    @Test
    public void testGetServerStatus() {
        Mockito.when(mockWorker.isHealthServer()).thenReturn(true);
        Assert.assertEquals("UP", nacosConfigService.getServerStatus());
        Mockito.verify(mockWorker, Mockito.times(1)).isHealthServer();
        
        Mockito.when(mockWorker.isHealthServer()).thenReturn(false);
        Assert.assertEquals("DOWN", nacosConfigService.getServerStatus());
        Mockito.verify(mockWorker, Mockito.times(2)).isHealthServer();
