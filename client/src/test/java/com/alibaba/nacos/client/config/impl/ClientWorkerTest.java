...
public class ClientWorkerTest {
    ...
    public void testListenerWithTenant() throws NacosException {
        ...
        String content = "d";
        clientWorker.addTenantListenersWithContent(
    ...
    public void testPublishConfig() throws NacosException {
        ...
        final NacosClientProperties nacosClientProperties =
                NacosClientProperties.PROTOTYPE.derive(prop);
        ClientWorker clientWorker = new ClientWorker(filter, agent, nacosClientProperties);
        ClientWorker.ConfigRpcTransportClient mockClient =
        ...
        boolean b =
                clientWorker.publishConfig(
                        dataId, group, tenant, appName, tag, betaIps, content, null, casMd5, type);
    ...
    @Test
    public void testIsHealthServer()
