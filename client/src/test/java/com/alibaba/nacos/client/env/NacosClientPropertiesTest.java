...
public class NacosClientPropertiesTest {
    ...
    public void testGetPropertyDefaultValue() {
        final String value =
                NacosClientProperties.PROTOTYPE.getProperty(
                        "nacos.home.default", "/home/default_value");
    ...
    public void testGetPropertyFrom() {
        ...
        NacosClientProperties.PROTOTYPE.setProperty(
                "nacos.home.default.test", "/home/properties_args");

        Assert.assertEquals(
                NacosClientProperties.PROTOTYPE.getPropertyFrom(
                        SourceType.JVM, "nacos.home.default.test"),
                "/home/jvm_args");
        Assert.assertEquals(
                NacosClientProperties.PROTOTYPE.getPropertyFrom(
                        SourceType.PROPERTIES, "nacos.home.default.test"),
