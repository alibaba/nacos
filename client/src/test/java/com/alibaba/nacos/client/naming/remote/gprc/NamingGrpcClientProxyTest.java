...
public class NamingGrpcClientProxyTest {
    ...
    public void testIsAbilitySupportedByServer1() {
        when(this.rpcClient.getConnectionAbility(AbilityKey.SUPPORT_PERSISTENT_INSTANCE_BY_GRPC))
                .thenReturn(AbilityStatus.SUPPORTED);
        Assert.assertTrue(client.isAbilitySupportedByServer(AbilityKey.SUPPORT_PERSISTENT_INSTANCE_BY_GRPC));
        verify(this.rpcClient, times(1))
                .getConnectionAbility(AbilityKey.SUPPORT_PERSISTENT_INSTANCE_BY_GRPC);
    }
    ...
    public void testIsAbilitySupportedByServer2() {
        ...
        Assert.assertFalse(client.isAbilitySupportedByServer(AbilityKey.SUPPORT_PERSISTENT_INSTANCE_BY_GRPC));
        verify(this.rpcClient, times(1))
                .getConnectionAbility(AbilityKey.SUPPORT_PERSISTENT_INSTANCE_BY_GRPC);
    }
