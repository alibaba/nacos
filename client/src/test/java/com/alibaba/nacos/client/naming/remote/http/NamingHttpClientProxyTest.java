...
public class NamingHttpClientProxyTest {
    ...
    @Mock private ServerListManager mgr;
    ...
    public void testDeregisterService() throws Exception {
        ...
        verify(nacosRestTemplate, times(1))
                .exchangeForm(any(), any(), any(), any(), eq(HttpMethod.DELETE), any());
    }
    ...
    public void testUpdateInstance() throws Exception {
        ...
        // then
        verify(nacosRestTemplate, times(1))
                .exchangeForm(any(), any(), any(), any(), eq(HttpMethod.PUT), any());
    }
    ...
    public void testQueryService() throws Exception {
        ...
        verify(nacosRestTemplate, times(1))
                .exchangeForm(
                        endsWith(UtilAndComs.nacosUrlService),
                        any(),
                        any(),
                        any(),
                        eq(HttpMethod.GET),
    ...
    public void testGetServiceList() throws Exception {
        ...
        verify(nacosRestTemplate, times(1))
                .exchangeForm(
                        endsWith("/service/list"), any(), any(), any(), eq(HttpMethod.GET), any());
