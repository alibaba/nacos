...
/**
 * Unified thread pool creation factory, and actively create thread pool resources by
 * ThreadPoolManager for unified life cycle management {@link ExecutorFactory.Managed}.
 *
...
public final class ExecutorFactory {
    ...
    public static ExecutorService newFixedExecutorService(
    ...
    public static final class Managed {
         ...
         */
        public static ExecutorService newSingleExecutorService(
                final String group, final ThreadFactory threadFactory) {
         ...
         */
        public static ExecutorService newFixedExecutorService(
                final String group, final int nThreads) {
         ...
         */
        public static ExecutorService newFixedExecutorService(
                final String group, final int nThreads, final ThreadFactory threadFactory) {
        ...
        /**
         * Create a new single scheduled executor service with input thread factory and register to
         * manager.
         *
         * @param group group name
         * @param threadFactory thread factory
        ...
        /**
         * Create a new scheduled executor service with input thread factory and register to
         * manager.
         *
         * @param group group name
         * @param nThreads thread number
