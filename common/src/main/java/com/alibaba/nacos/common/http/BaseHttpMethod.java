...
public enum BaseHttpMethod {
     ...
     *
     * <p>Mainly used for GET request parameters are relatively large, can not be placed on the URL,
     * so it needs to be placed in the body.
     */
     ...
     *
     * <p>Mainly used for DELETE request parameters are relatively large, can not be placed on the
     * URL, so it needs to be placed in the body.
     */
