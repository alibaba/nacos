...
/**
 * For NacosRestTemplate and NacosAsyncRestTemplate, provide initialization and register of response
 * converter.
 *
 * @author mai.jh
 */
...
public abstract class AbstractNacosRestTemplate {
    ...
    private void initDefaultResponseHandler() {
        ...
        responseHandlerMap.put(
                ResponseHandlerType.RESTRESULT_TYPE, new RestResultResponseHandler());
    ...
    public void registerResponseHandler(
            String responseHandlerType, ResponseHandler responseHandler) {
