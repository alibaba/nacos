 ...
 * Resource} implementation for class path resources. Uses either a given {@link ClassLoader} or a
 * given {@link Class} for loading resources.
 *
...
public class ClassPathResource extends AbstractFileResolvingResource {
     ...
     * {@link AbstractFileResolvingResource}'s length check.
     *
     * @see ClassLoader#getResource(String)
     * @see Class#getResource(String)
     */
