 ...
 * Resource} implementation for {@code java.io.File} and {@code java.nio.file.Path} handles with a
 * file system target. Supports resolution as a {@code File} and also as a {@code URL}. Implements
 ...
 * read/write interactions. As of 5.1, it may be constructed with a {@link Path} handle in which
 * case it will perform all file system interactions via NIO.2, only resorting to {@link File} on
 * {@link #getFile()}.
 *
...
public class FileSystemResource extends AbstractResource implements WritableResource {
     ...
     * &rarr; "C:/dir1/dir2". In the case of "C:/dir1", relative paths will apply at the same
     * directory level: relative path "dir2" &rarr; "C:/dir2".
     *
     ...
     * &rarr; "C:/dir2"! If you prefer to have relative paths built underneath the given root
     * directory, use the {@link #FileSystemResource(String) constructor with a file path} to append
     * a trailing slash to the root path: "C:/dir1/", which indicates this directory as root for all
     * relative paths.
     *
     ...
     * directory, use the {@link #FileSystemResource(String) constructor with a file path} to append
     * a trailing slash to the root path: "C:/dir1/", which indicates this directory as root for all
     * relative paths. Alternatively, consider using {@link PathResource#PathResource(Path)} for
     * {@code java.nio.path.Path} resolution in {@code createRelative}, always nesting relative
     * paths.
     *
