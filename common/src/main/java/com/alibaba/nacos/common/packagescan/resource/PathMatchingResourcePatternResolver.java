 ...
 * {@link ResourcePatternResolver} implementation that is able to resolve a specified resource
 * location path into one or more matching Resources. The source path may be a simple path which has
 * a one-to-one mapping to a target {@link Resource}, or alternatively may contain the special
 * "{@code classpath*:}" prefix and/or internal Ant-style regular expressions (matched using
 * Spring's {@link AntPathMatcher} utility). Both of the latter are effectively wildcards.
 *
 * <p><b>No Wildcards:</b>
 *
...
public class PathMatchingResourcePatternResolver implements ResourcePatternResolver {
    ...
    private static final Logger LOGGER =
            LoggerFactory.getLogger(PathMatchingResourcePatternResolver.class);
    ...
    protected Resource[] findPathMatchingResources(String locationPattern) throws IOException {
        ...
        for (Resource rootDirResource : rootDirResources) {
            ...
            if (equinoxResolveMethod != null && rootDirUrl.getProtocol().startsWith("bundle")) {
                URL resolvedUrl =
                        (URL) ReflectUtils.invokeMethod(equinoxResolveMethod, null, rootDirUrl);
                if (resolvedUrl != null) {
