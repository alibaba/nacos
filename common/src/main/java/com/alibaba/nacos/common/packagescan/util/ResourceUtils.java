 ...
 * file resources in a uniform manner. method can resolve any location to a {@link Resource} object,
 * which in turn allows one to obtain a {@code java.io.File} in the file system through its {@code
 * getFile()} method.
 *
