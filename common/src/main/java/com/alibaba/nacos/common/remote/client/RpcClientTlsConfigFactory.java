...
public class RpcClientTlsConfigFactory implements RpcTlsConfigFactory {
    ...
    public RpcClientTlsConfig createSdkConfig(Properties properties) {
        ...
        tlsConfig.setTrustAll(
                getBooleanProperty(properties, NACOS_CLIENT_RPC + TLS_TRUST_ALL, true));
        tlsConfig.setCertPrivateKeyPassword(
                properties.getProperty(NACOS_CLIENT_RPC + TLS_TRUST_PWD));
    ...
    public RpcClientTlsConfig createClusterConfig(Properties properties) {
        ...
        tlsConfig.setCertChainFile(properties
                .getProperty(NACOS_PEER_RPC + RpcConstants.ServerSuffix.TLS_CERT_CHAIN_PATH));
