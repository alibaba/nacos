...
public class GrpcConstants {
    ...
    @GRpcConfigLabel public static final String GRPC_NAME = NACOS_CLIENT_GRPC + ".name";
    ...
    @GRpcConfigLabel public static final String GRPC_TIMEOUT_MILLS = NACOS_CLIENT_GRPC + ".timeout";
    ...
    @GRpcConfigLabel public static final String GRPC_QUEUESIZE = NACOS_CLIENT_GRPC + ".queue.size";
