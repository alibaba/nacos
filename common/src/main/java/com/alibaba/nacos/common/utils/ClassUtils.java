...
public final class ClassUtils {
    ...
    /**
     * Determines if the class or interface represented by this object is either the same as, or is
     * a superclass or superinterface of, the class or interface represented by the specified
     * parameter.
     *
     ...
     * resolving nested class names in Java source style (e.g. "java.lang.Thread.State" instead of
