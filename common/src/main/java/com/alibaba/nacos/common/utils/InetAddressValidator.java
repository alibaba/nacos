/**
 * Copyright 2018-2021 Dynatrace LLC Licensed under the Apache License, Version 2.0 (the "License");
...
public class InetAddressValidator {
    ...
    /**
     * Check if <code>input</code> is a valid IPv4 address. The format is 'xxx.xxx.xxx.xxx'. Four
     * blocks of integer numbers ranging from 0 to 255 are required. Letters are not allowed.
     *
    ...
    /**
     * Check if the given address is a valid IPv6 address in the hex-compressed notation The format
     * is 'xxxx:xxxx:xxxx:xxxx:xxxx:xxxx:xxxx:xxxx'. If all digits in a block are '0' the block can
     * be left empty.
     *
     * @param input ip-address to check
    ...
    /**
     * Check if <code>input</code> is a IPv6 address. Possible notations for valid IPv6 are: -
     * Standard IPv6 address - Hex-compressed IPv6 address - Link-local IPv6 address -
     * IPv4-mapped-to-IPV6 address - IPv6 mixed address
     *
     * @param input ip-address to check
     * @return true if <code>input</code> is in correct IPv6 notation.
     */
    ...
    /**
     * Check if the given address is a valid IPv6 address in the mixed-standard or mixed-compressed
     * notation. IPV6 Mixed mode consists of two parts, the first 96 bits (up to 6 blocks of 4 hex
     * digits) are IPv6 the IPV6 part can be either compressed or uncompressed the second block is a
     * full IPv4 address e.g. '0:0:0:0:0:0:172.12.55.18'
     *
     * @param input ip-address to check
     * @return true if <code>input</code> is in correct IPv6 (mixed-standard or mixed-compressed)
     *     notation.
     */
    ...
    /**
     * Check if <code>input</code> is an IPv4 address mapped into a IPv6 address. These are starting
     * with "::ffff:" followed by the IPv4 address in a dot-seperated notation. The format is
     * '::ffff:d.d.d.d'
     *
     * @param input ip-address to check
