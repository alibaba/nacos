...
public class StringUtils {
    ...
    /**
     * Removes control characters (char &lt;= 32) from both ends of this String, handling {@code
     * null} by returning {@code null}.
     *
    ...
    /**
     * Splits the provided text into an array with a maximum length, separators specified. If
     * separatorChars is empty, divide by blank.
     *
