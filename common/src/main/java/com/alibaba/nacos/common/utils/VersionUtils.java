...
public class VersionUtils {
    ...
    public static int compareVersion(final String versionA, final String versionB) {
        ...
        int major = Integer.compare(parseVersionPart(sA[0], versionA),
                parseVersionPart(sB[0], versionB));
        if (major != 0) {
            return major;
        }
        int minor = Integer.compare(parseVersionPart(sA[1], versionA),
                parseVersionPart(sB[1], versionB));
        if (minor != 0) {
            return minor;
        }
