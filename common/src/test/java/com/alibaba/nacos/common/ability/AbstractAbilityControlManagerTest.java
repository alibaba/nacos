...
class AbstractAbilityControlManagerTest {
    ...
    void testIsCurrentNodeAbilityRunning() {
        ...
        assertEquals(AbilityStatus.NOT_SUPPORTED, abilityControlManager
                .isCurrentNodeAbilityRunning(AbilityKey.SERVER_DISTRIBUTED_LOCK));
        assertEquals(AbilityStatus.UNKNOWN, abilityControlManager
                .isCurrentNodeAbilityRunning(AbilityKey.SDK_CLIENT_FUZZY_WATCH));
    }
