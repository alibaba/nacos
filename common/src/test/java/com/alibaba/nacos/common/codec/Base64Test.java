...
public class Base64Test {
    ...
    public void testChunk() {
        ...
        byte[] b1 =
                Base64.encodeBase64(
                        a.getBytes(StandardCharsets.UTF_8), false, false, Integer.MAX_VALUE);
        byte[] b2 =
                Base64.encodeBase64(
                        a.getBytes(StandardCharsets.UTF_8), true, false, Integer.MAX_VALUE);
    ...
    public void testUrlSafe() {
        ...
        byte[] b2 =
                Base64.encodeBase64(
                        a.getBytes(StandardCharsets.UTF_8), false, true, Integer.MAX_VALUE);
        String s1 = new String(b1);
        String s2 = new String(b2);
