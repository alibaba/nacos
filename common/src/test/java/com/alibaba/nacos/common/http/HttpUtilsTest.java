...
public class HttpUtilsTest {
    ...
    public void testInitRequestEntity4() throws Exception {
        ...
        // nothing change
        Assert.assertEquals(
                new BaseHttpMethod.HttpGetWithEntity("").getEntity(), httpRequest.getEntity());
        Assert.assertArrayEquals(
                new BaseHttpMethod.HttpGetWithEntity("").getAllHeaders(),
    ...
    public void testInitRequestFromEntity4() throws Exception {
        ...
        HttpUtils.initRequestFromEntity(
                mock(HttpRequestBase.class), Collections.emptyMap(), "UTF-8");
