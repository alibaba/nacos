...
public class ResponseHandlerTest {
    ...
    public void testDeserializationType() throws Exception {
        ...
        ArrayList<Integer> tmp =
                ResponseHandler.convert(json, TypeUtils.parameterize(List.class, Integer.class));
    ...
    public void testRestResult() throws Exception {
        String json =
                "{\"code\":200,\"message\":null,\"data\":[{\"USERNAME\":\"nacos\",\"PASSWORD\":"
                        + "\"$2a$10$EuWPZHzz32dJN7jexM34MOeYirDdFAZm2kuWj7VEOJhhZkDrxfvUu\",\"ENABLED\":true}]}";
        RestResult<Object> result =
                ResponseHandler.convert(
                        json, TypeUtils.parameterize(RestResult.class, Object.class));
