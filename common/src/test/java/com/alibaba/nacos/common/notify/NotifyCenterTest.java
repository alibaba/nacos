    ...
    public void testMutipleSlowEventsListenedBySmartsubscriber() throws Exception {
        ...
        NotifyCenter.registerSubscriber(
                new SmartSubscriber() {
                    ...
                    @Override
                    public List<Class<? extends Event>> subscribeTypes() {
                        List<Class<? extends Event>> subTypes =
