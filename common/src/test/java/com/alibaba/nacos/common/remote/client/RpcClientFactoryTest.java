...
public class RpcClientFactoryTest {
    ...
    public void testDestroyClientWhenClientExistThenRemoveAndShutDownRpcClient()
        ...
        clientMapField.set(
                null, new ConcurrentHashMap<>(Collections.singletonMap("testClient", rpcClient)));
    ...
    @Test
    public void testDestroyClientWhenClientNotExistThenDoNothing()
            throws IllegalAccessException, NacosException {
        clientMapField.set(
                null, new ConcurrentHashMap<>(Collections.singletonMap("testClient", rpcClient)));
