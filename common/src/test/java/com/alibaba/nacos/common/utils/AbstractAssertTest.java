...
public class AbstractAssertTest {
    ...
    public void testState() {
        assertThrows(
                ...
                () -> AbstractAssert.state(false, "error message"));
        assertThrows(
                "error",
                IllegalStateException.class,
                () -> AbstractAssert.state(false, () -> "error"));
    }
    ...
    public void testIsTrue() {
        assertThrows(
                ...
                () -> AbstractAssert.isTrue(false, "error"));
        assertThrows(
                "error",
                IllegalArgumentException.class,
                () -> AbstractAssert.isTrue(false, () -> "error"));
    ...
    public void testIsNull() {
        assertThrows(
                "error",
                IllegalArgumentException.class,
                () -> AbstractAssert.isNull(new Object(), "error"));
        assertThrows(
                "error",
                IllegalArgumentException.class,
                () -> AbstractAssert.isNull(new Object(), () -> "error"));
    ...
    public void testNotNull() {
        assertThrows(
                "error",
                IllegalArgumentException.class,
                () -> AbstractAssert.notNull(null, "error"));
        assertThrows(
                "error",
                IllegalArgumentException.class,
                () -> AbstractAssert.notNull(null, () -> "error"));
    ...
    public void testHasLength() {
        assertThrows(
                "error",
                IllegalArgumentException.class,
                () -> AbstractAssert.hasLength(null, "error"));
        assertThrows(
                "error",
                IllegalArgumentException.class,
                () -> AbstractAssert.hasLength(null, () -> "error"));
    ...
    public void testHasText() {
        assertThrows(
                "error",
                IllegalArgumentException.class,
                () -> AbstractAssert.hasText(null, "error"));
        assertThrows(
                "error",
                IllegalArgumentException.class,
                () -> AbstractAssert.hasText(null, () -> "error"));
    ...
    public void testDoesNotContain() {
        assertThrows(
                IllegalArgumentException.class, () -> AbstractAssert.doesNotContain("abcd", "bc"));
        assertThrows(
                "error",
                IllegalArgumentException.class,
    ...
    public void testNoNullElements() {
        ...
        assertThrows(
                "error",
                IllegalArgumentException.class,
                () -> AbstractAssert.noNullElements(list, "error"));
        assertThrows(
                "error",
                IllegalArgumentException.class,
                () -> AbstractAssert.noNullElements(list, () -> "error"));
    ...
    public void testIsInstanceOf() {
        assertThrows(
                "",
                IllegalArgumentException.class,
                () -> AbstractAssert.isInstanceOf(String.class, new Object()));
        assertThrows(
                "error",
                IllegalArgumentException.class,
    ...
    public void testIsAssignable() {
        assertThrows(
                "",
                IllegalArgumentException.class,
                () -> AbstractAssert.isAssignable(String.class, null));
        assertThrows(
                "error",
                IllegalArgumentException.class,
