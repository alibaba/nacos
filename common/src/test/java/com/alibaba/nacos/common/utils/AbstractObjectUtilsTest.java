...
public class AbstractObjectUtilsTest {
    ...
    public void testIsCompatibleWithThrowsClause() {
        assertTrue(
                AbstractObjectUtils.isCompatibleWithThrowsClause(
                        new NacosException(), Exception.class));
        assertFalse(
                AbstractObjectUtils.isCompatibleWithThrowsClause(
                        new NacosException(), RuntimeException.class));
    }
    ...
    public void testCaseInsensitiveValueOf() {
        assertEquals(
                ETest.CASE1, AbstractObjectUtils.caseInsensitiveValueOf(ETest.values(), "case1"));
        assertThrows(
    ...
    public void testToObjectArray() {
        ...
        assertThrows(
                IllegalArgumentException.class,
                () -> AbstractObjectUtils.toObjectArray(new Object()));
    }
    ...
    public void testNullSafeEquals() {
        ...
        assertFalse(
                AbstractObjectUtils.nullSafeEquals(new Integer[] {1, 2}, new Integer[] {1, 2, 3}));
    }
    ...
    public void testIdentityToString() {
        ...
        String str = "1";
        assertEquals(
                str.getClass().getName() + "@" + Integer.toHexString(System.identityHashCode(str)),
    ...
    public void testGetIdentityHexString() {
        assertEquals(
                ...
                AbstractObjectUtils.getIdentityHexString("1"));
    }
    ...
    public void testNullSafeToString() {
        ...
        assertEquals(
                "{true, false}", AbstractObjectUtils.nullSafeToString(new boolean[] {true, false}));
