...
/**
 * InetAddressValidator Test. @ClassName: InetAddressValidatorTest @Author: ChenHao26 @Date:
 * 2022/8/22 13:07
 */
public class InetAddressValidatorTest {
    ...
    public void isIPv6Address() {
        Assert.assertTrue(
                InetAddressValidator.isIPv6Address("2000:0000:0000:0000:0001:2345:6789:abcd"));
