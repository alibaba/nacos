...
/**
 * test IpUtil. @ClassName: IpUtilTest
 *
 * @date 2020/9/3 10:31
 */
...
public class InternetAddressUtilTest {
    ...
    public void testGetIPFromString() {
        Assert.assertEquals(
                "[::1]",
                InternetAddressUtil.getIPFromString(
                        "http://[::1]:666/xzdsfasdf/awerwef" + "?eewer=2&xxx=3"));
        Assert.assertEquals(
                "[::1]",
                InternetAddressUtil.getIPFromString(
        ...
        Assert.assertEquals(
                "127.0.0.1",
                InternetAddressUtil.getIPFromString(
                        "http://127.0.0.1:666/xzdsfasdf/awerwef" + "?eewer=2&xxx=3"));
        Assert.assertEquals(
                "127.0.0.1",
                InternetAddressUtil.getIPFromString(
        ...
        Assert.assertEquals(
                "",
                InternetAddressUtil.getIPFromString(
                        "http://[dddd]:666/xzdsfasdf/awerwef" + "?eewer=2&xxx=3"));
        Assert.assertEquals(
                "",
                InternetAddressUtil.getIPFromString(
                        "jdbc:mysql://[127.0.0.1]:3306/nacos_config_test?characterEncoding=utf8&connectTimeout=1000"
    ...
    public void testSplitIpPort() {
        ...
        checkSplitIPPortStr("[dead:beef]:88", false, "[dead:beef]", "88");
        checkSplitIPPortStr(
                "[fe80::3ce6:7132:808e:707a%19]:88", false, "[fe80::3ce6:7132:808e:707a%19]", "88");
    ...
    public void testCheckIPs() {
        ...
        Assert.assertEquals(
                "illegal ip: 127.100.19", InternetAddressUtil.checkIPs("127.100.19", "127.0.0.1"));
    }
    ...
    public void testRemoveBrackets() {
        Assert.assertEquals(
                InternetAddressUtil.removeBrackets("[2001:DB8:0:0:1::1]"), "2001:DB8:0:0:1::1");
