...
/**
 * * Created with IntelliJ IDEA. User: dingjoey Date: 13-12-12 Time: 21:12 client api && sdk api
 * 请求日志打点逻辑
 *
 * @author Nacos
 */
...
public class RequestLogAspect {
    ...
    public Object interfacePublishSingleRpc(
    ...
    public Object interfacePublishSingle(
        ...
        Object retVal =
                logClientRequest(
                        "publish", pjp, request, response, dataId, group, tenant, md5, rtHolder);
    ...
    public Object interfaceRemoveAll(
            ProceedingJoinPoint pjp,
            HttpServletRequest request,
            HttpServletResponse response,
            String dataId,
        ...
        return logClientRequest(
                "remove", pjp, request, response, dataId, group, tenant, null, null);
    }

    /** RemoveAll. */
    @Around(CLIENT_INTERFACE_REMOVE_ALL_CONFIG_RPC)
    public Object interfaceRemoveAllRpc(
            ProceedingJoinPoint pjp, ConfigRemoveRequest request, RequestMeta meta)
            throws Throwable {
        return logClientRequestRpc(
                "remove",
                pjp,
                request,
                meta,
    ...
    public Object interfaceGetConfig(
            ProceedingJoinPoint pjp,
            HttpServletRequest request,
            HttpServletResponse response,
            String dataId,
        ...
        Object retVal =
                logClientRequest(
                        "get", pjp, request, response, dataId, group, tenant, md5, rtHolder);
    ...
    public Object interfaceGetConfigRpc(
            ProceedingJoinPoint pjp, ConfigQueryRequest request, RequestMeta meta)
            throws Throwable {
    ...
    private Object logClientRequest(
            String requestType,
            ProceedingJoinPoint pjp,
            HttpServletRequest request,
            HttpServletResponse response,
    ...
    /** Client api request log rt | status | requestIp | opType | dataId | group | datumId | md5. */
    private Object logClientRequestRpc(
            String requestType,
            ProceedingJoinPoint pjp,
            Request request,
            RequestMeta meta,
        ...
        LogUtil.CLIENT_LOG.info(
                "{}|{}|{}|{}|{}|{}|{}|{}|{}",
                rt,
                retVal.isSuccess() ? retVal.getResultCode() : retVal.getErrorCode(),
                requestIp,
                requestType,
                dataId,
                group,
    ...
    public Object interfaceListenConfigRpc(
            ProceedingJoinPoint pjp, ConfigBatchListenRequest request, RequestMeta meta)
            throws Throwable {
        MetricsMonitor.getConfigMonitor().incrementAndGet();
        final String requestIp = meta.getClientIp();
        String appName = request.getHeader(RequestUtil.CLIENT_APPNAME_HEADER);
        ...
        LogUtil.CLIENT_LOG.info(
                ...
                requestIp,
                "listen",
                request.getConfigListenContexts().size(),
                request.isListen(),
                "",
                "",
                appName);
