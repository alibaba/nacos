...
public class LocalDataSourceConfiguration {
    ...
    private static final String APP_HOME = System.getProperty(NACOS_HOME_KEY, DEFAULT_APP_NAME);

    private static final String DATAS_SOURCE_URL = "jdbc:derby:" + APP_HOME + File.separator + DERBY_BASE_DIR +
            ";create=true";
