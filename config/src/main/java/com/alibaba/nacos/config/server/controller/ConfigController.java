...
public class ConfigController {
    ...
    public Page<ConfigInfo> searchConfig(@RequestParam("dataId") String dataId, @RequestParam("group") String group,
        ...
        try {
            return persistService
                    .findConfigInfoExcludeContent4Page(pageNo, pageSize, dataId, group, tenant, configAdvanceInfo);
        } catch (Exception e) {
    ...
    public Page<ConfigInfo> fuzzySearchConfig(@RequestParam("dataId") String dataId,
        ...
        try {
            return persistService
                    .findConfigInfoExcludeContentLike4Page(pageNo, pageSize, dataId, group, tenant, configAdvanceInfo);
        } catch (Exception e) {
            String errorMsg = "serialize page error, dataId=" + dataId + ", group=" + group;
            LOGGER.error(errorMsg, e);
            throw new RuntimeException(errorMsg, e);
