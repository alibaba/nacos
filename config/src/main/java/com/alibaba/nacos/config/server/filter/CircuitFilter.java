...
/**
 * If the embedded distributed storage is enabled, all requests are routed to the Leader node for
 * processing, and the maximum number of forwards for a single request cannot exceed three.
 *
...
public class CircuitFilter implements Filter {
    ...
    @Autowired private ServerMemberManager memberManager;

    @Autowired private CPProtocol protocol;
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        try {
            // If an unrecoverable exception occurs on this node, the write request operation shall
            // not be processed
