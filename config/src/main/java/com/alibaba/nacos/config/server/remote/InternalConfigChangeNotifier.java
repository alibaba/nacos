...
import static com.alibaba.nacos.config.server.service.ConfigRuleExternalRuleStorage.DATA_ID_CONNECTION_LIMIT_RULE;
import static com.alibaba.nacos.config.server.service.ConfigRuleExternalRuleStorage.DATA_ID_TPS_CONTROL_RULE;
import static com.alibaba.nacos.config.server.service.ConfigRuleExternalRuleStorage.NACOS_GROUP;
import static com.alibaba.nacos.config.server.service.ConfigRuleExternalRuleStorage.RULE_CONFIG_NAMESPACE;
