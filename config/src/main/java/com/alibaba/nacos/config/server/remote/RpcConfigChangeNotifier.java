...
public class RpcConfigChangeNotifier extends Subscriber<LocalDataChangeEvent> {
    ...
    @Autowired private RpcPushService rpcPushService;
    ...
    public void configDataChanged(
        ...
        for (final String client : listeners) {
            ...
            RpcPushTask rpcPushRetryTask =
                    new RpcPushTask(
                            notifyRequest,
                            ConfigCommonConfig.getInstance().getMaxPushRetryTimes(),
                            client,
                            clientIp,
                            metaInfo.getAppName());
                        ...
                        new AbstractPushCallBack(3000L) {
                            ...
                            public void onFail(Throwable e) {
                                ...
                                Loggers.REMOTE_PUSH.warn(
                                        "Push fail, dataId={}, group={}, tenant={}, clientId={}",
                                        notifyRequest.getDataId(),
                                        notifyRequest.getGroup(),
                                        notifyRequest.getTenant(),
                                        connectionId,
                                        e);
