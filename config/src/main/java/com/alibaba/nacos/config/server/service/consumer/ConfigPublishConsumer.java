 ...
 */
@Component
public class ConfigPublishConsumer extends BaseConsumer<ConfigRequest> {
    ...
    protected void process(ConfigRequest configRequest) {
        persistService.addConfigInfoAtomic(configRequest.getId(),
                ...
                configRequest.getConfigInfo(),
                configRequest.getTime(),
                configRequest.getConfigAdvanceInfo());
    }
}
