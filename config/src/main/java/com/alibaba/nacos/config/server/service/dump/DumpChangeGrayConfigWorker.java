                ...
                for (ConfigInfoStateWrapper configInfo : configDeleted) {
                    try {
                        ...
                        if (configInfoStateWrapper == null) {
                            ConfigCacheService.removeGray(configInfo.getDataId(),
                        ...
                        LogUtil.DUMP_LOG.error("[dump-change-gray-delete-rejected] {}",
                            e.getMessage());
                    ...
                    try {
                        ...
                        if (newLastModified || md5Update) {
                            ...
                            LogUtil.DUMP_LOG.info(
                                "[dump-change-gray] find change config  {}, {}, md5={}",
                                new Object[] {groupKey, cf.getLastModified(), cf.getMd5()});
                            ConfigCacheService.dumpGray(cf.getDataId(), cf.getGroup(),
                        ...
                        LogUtil.DUMP_LOG.error("[dump-change-gray-rejected] {}", e.getMessage());
                        if (rejectedPathException == null) {
                            rejectedPathException = e;
                        }
                    }
