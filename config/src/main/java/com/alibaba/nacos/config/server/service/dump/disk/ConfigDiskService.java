...
public interface ConfigDiskService {
     ...
     * @throws IOException io exception.
     */
    void saveBetaToDisk(String dataId, String group, String tenant, String content)
            throws IOException;
     ...
     * @throws IOException io exception.
     */
    void saveBatchToDisk(String dataId, String group, String tenant, String content)
            throws IOException;
     ...
     * @throws IOException io exception.
     */
    void saveTagToDisk(String dataId, String group, String tenant, String tag, String content)
            throws IOException;
     ...
     * @throws IOException io exception.
     */
    String getLocalConfigMd5(String dataId, String group, String tenant, String encode)
            throws IOException;
