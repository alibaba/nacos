...
/**
 * Service to notify other nodes to get the latest data. Monitor data change events and notify all
 * servers.
 *
 * @author jiuRen
 */
public class NotifyService {
    ...
    /**
     * In order to facilitate the system beta, without changing the notify.do interface, the new
     * lastModifed parameter is passed through the Http header.
     */
    ...
    public static RestResult<String> invokeURL(String url, List<String> headers, String encoding)
            throws Exception {
