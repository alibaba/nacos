...
public interface ConfigInfoBetaPersistService {
     ...
     */
    ConfigInfoStateWrapper findConfigInfo4BetaState(
     ...
     */
    ConfigOperateResult addConfigInfo4Beta(
     ...
     */
    ConfigOperateResult insertOrUpdateBetaCas(
            final ConfigInfo configInfo,
            final String betaIps,
            final String srcIp,
            final String srcUser);
     ...
     * @return config operation result.
     */
    ConfigOperateResult updateConfigInfo4Beta(
            ConfigInfo configInfo, String betaIps, String srcIp, String srcUser);
     ...
     * @return success or not.
     */
    ConfigOperateResult updateConfigInfo4BetaCas(
            ConfigInfo configInfo, String betaIps, String srcIp, String srcUser);
