...
public interface PersistService {
    ...
    /**
     * Delete config info by dataIds.
     *
     * @param tenant  tenant
     * @param items   group and dataId pair list
     * @param srcUser user
     * @param srcIp   remote ip
     * @return {@link ConfigInfo} list
     * @author robert
     */
    List<ConfigInfo> removeConfigInfoByGroupAndDataId(
    ...
    /**
     * query all configuration information according to namesapce(tenant), group, dataId (for export).
     *
     * @param tenant  tenant
     * @param items   group and dataId pair values
     * @return Collection of ConfigInfo objects
     */
    List<ConfigAllInfo> findAllConfigInfo4Export(final String tenant, List<GroupAndDataId> items);
