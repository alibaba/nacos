...
/**
 * Database service, providing access to ConfigInfo in the database <br>
 * 3.0 starts to increase the data version number, and changes the physical deletion to logical
 * deletion <br>
 ...
 * @author klw
 * @since 1.0 <br>
 *     PersistService has been deprecated and will be removed in future versions. It is recommended
 *     to use ConfigInfoPersistService, ConfigInfoTagPersistService, ConfigInfoBetaPersistService,
 *     ConfigInfoAggrPersistService, HistoryConfigInfoPersistService, OtherPersistService
 */
@Deprecated
public interface PersistService {
     ...
     */
    @Deprecated
    boolean updateConfigInfo4BetaCas(
            ConfigInfo configInfo,
            String betaIps,
            String srcIp,
            String srcUser,
     ...
     */
    @Deprecated
    boolean updateConfigInfo4TagCas(
            ConfigInfo configInfo,
            String tag,
            String srcIp,
            String srcUser,
     ...
     */
    @Deprecated
    void removeSingleAggrConfigInfo(
    ...
    /**
     * Add or update data in batches. Any exception during the transaction will force a
     * TransactionSystemException to be thrown.
     *
     * @param dataId dataId
     * @param group group
     * @param tenant tenant
    ...
    /**
     * Batch replacement, first delete all the specified DataID+Group data in the aggregation table,
     * and then insert the data. Any exception during the transaction process will force a
     * TransactionSystemException to be thrown.
     *
     * @param dataId dataId
     * @param group group
     ...
     */
    @Deprecated
    ConfigInfoBetaWrapper findConfigInfo4Beta(
     ...
     */
    @Deprecated
    ConfigInfoAggr findSingleConfigInfoAggr(
     ...
     */
    @Deprecated
    Page<ConfigInfoAggr> findConfigInfoAggrByPage(
     ...
     */
    @Deprecated
    Page<ConfigInfoAggr> findConfigInfoAggrLike(
