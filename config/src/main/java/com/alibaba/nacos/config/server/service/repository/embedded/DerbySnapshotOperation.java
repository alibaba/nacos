...
public class DerbySnapshotOperation implements SnapshotOperation {
    ...
    private final String derbyBaseDir = Paths.get(EnvUtil.getNacosHome(), "data", Constants.DERBY_DIR_NAME).toString();
    ...
    public boolean onSnapshotLoad(Reader reader) {
        ...
        try {
            ...
            final String loadPath = Paths.get(readerPath, snapshotDir, Constants.DERBY_DIR_NAME).toString();
