...
public class EmbeddedConfigInfoBetaPersistServiceImpl implements ConfigInfoBetaPersistService {
    ...
    @Override
    public ConfigInfoStateWrapper findConfigInfo4BetaState(
    ...
    @Override
    public ConfigOperateResult addConfigInfo4Beta(
            ConfigInfo configInfo, String betaIps, String srcIp, String srcUser) {
        String appNameTmp =
    ...
    @Override
    public ConfigOperateResult insertOrUpdateBeta(
    ...
    @Override
    public ConfigOperateResult insertOrUpdateBetaCas(
            final ConfigInfo configInfo,
            final String betaIps,
            final String srcIp,
            final String srcUser) {
    ...
    @Override
    public ConfigOperateResult updateConfigInfo4Beta(
            ConfigInfo configInfo, String betaIps, String srcIp, String srcUser) {
        String appNameTmp =
                StringUtils.isBlank(configInfo.getAppName())
                        ? StringUtils.EMPTY
    ...
    @Override
    public ConfigOperateResult updateConfigInfo4BetaCas(
            ConfigInfo configInfo, String betaIps, String srcIp, String srcUser) {
        String appNameTmp =
                StringUtils.isBlank(configInfo.getAppName())
                        ? StringUtils.EMPTY
