...
public class EmbeddedConfigInfoPersistServiceImpl implements ConfigInfoPersistService {
     ...
     */
    public EmbeddedConfigInfoPersistServiceImpl(
    ...
    @Override
    public ConfigInfoStateWrapper findConfigInfoState(
        ...
        return databaseOperate.queryOne(
                sql, new Object[] {dataId, group, tenantTmp}, CONFIG_INFO_STATE_WRAPPER_ROW_MAPPER);
    }

    private ConfigOperateResult getConfigInfoOperateResult(
    ...
    @Override
    public ConfigOperateResult addConfigInfo(
            final String srcIp,
    ...
    private ConfigOperateResult addConfigInfo(
            final String srcIp,
            final String srcUser,
            final ConfigInfo configInfo,
            final Map<String, Object> configAdvanceInfo,
    ...
    @Override
    public ConfigOperateResult insertOrUpdate(
            String srcIp,
            String srcUser,
    ...
    @Override
    public ConfigOperateResult insertOrUpdateCas(
            String srcIp,
            String srcUser,
            ConfigInfo configInfo,
            Map<String, Object> configAdvanceInfo) {
    ...
    public void removeConfigInfoByIdsAtomic(final String ids) {
        ...
        EmbeddedStorageContextHolder.addSqlContext(
                result.getSql(), result.getParamList().toArray());
    }

    @Override
    public ConfigOperateResult updateConfigInfo(
            final ConfigInfo configInfo,
            final String srcIp,
            final String srcUser,
            final Map<String, Object> configAdvanceInfo) {
    ...
    @Override
    public ConfigOperateResult updateConfigInfoCas(
            final ConfigInfo configInfo,
            final String srcIp,
            final String srcUser,
            final Map<String, Object> configAdvanceInfo) {
    ...
    private ConfigOperateResult updateConfigInfoAtomicCas(
            final ConfigInfo configInfo,
            final String srcIp,
            final String srcUser,
            Map<String, Object> configAdvanceInfo) {
    ...
    public List<ConfigInfoWrapper> listGroupKeyMd5ByPage(int pageNo, int pageSize) {
        ...
        String sqlCountRows = configInfoMapper.count(null);
        MapperResult sqlFetchRows =
                configInfoMapper.listGroupKeyMd5ByPageFetchRows(
