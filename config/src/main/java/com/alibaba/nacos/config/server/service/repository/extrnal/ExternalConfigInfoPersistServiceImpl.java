...
public class ExternalConfigInfoPersistServiceImpl implements ConfigInfoPersistService {
        ...
        return tjt.execute(
                status -> {
                    try {
                        long configId =
                                addConfigInfoAtomic(
                                        -1, srcIp, srcUser, configInfo, configAdvanceInfo);
                        String configTags =
                        ...
                        historyConfigInfoPersistService.insertConfigHistoryAtomic(
                                0, configInfo, srcIp, srcUser, now, "I");
                        ConfigInfoStateWrapper configInfoCurrent =
                                this.findConfigInfoState(
                                        configInfo.getDataId(),
                                        configInfo.getGroup(),
                                        configInfo.getTenant());
                        ...
                        return new ConfigOperateResult(
                                configInfoCurrent.getId(), configInfoCurrent.getLastModified());
                ...
                status -> {
                    try {
                        ...
                        */
                        ...
                        historyConfigInfoPersistService.insertConfigHistoryAtomic(
                                oldConfigInfo.getId(), oldConfigInfo, srcIp, srcUser, now, "U");
                        ...
                        */
                        ...
                        int rows =
                                updateConfigInfoAtomicCas(
                                        configInfo, srcIp, srcUser, configAdvanceInfo);
                        if (rows < 1) {
                            return new ConfigOperateResult(false);
                        }
                        String configTags =
                        ...
                        return new ConfigOperateResult(
                                configInfoLast.getId(), configInfoLast.getLastModified());
                    } catch (CannotGetJdbcConnectionException e) {
                        LogUtil.FATAL_LOG.error("[db-error] " + e, e);
                        throw e;
                    }
    ...
    public List<ConfigInfoWrapper> convertChangeConfig(List<Map<String, Object>> list) {
        ...
        for (Map<String, Object> map : list) {
            ...
            long mTime =
                    ((LocalDateTime) map.get("gmt_modified"))
