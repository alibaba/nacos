...
public class ExternalStoragePersistServiceImpl implements PersistService {
        ...
        tjt.execute(
                status -> {
                    try {
                        long configId =
                                addConfigInfoAtomic(
                                        -1, srcIp, srcUser, configInfo, time, configAdvanceInfo);
                        String configTags =
                        ...
                        */
                        ...
                        int rows =
                                updateConfigInfoAtomicCas(
                                        configInfo, srcIp, srcUser, time, configAdvanceInfo);
                        if (rows < 1) {
    ...
    public List<ConfigInfo> removeConfigInfoByIds(
        ...
        return tjt.execute(
                new TransactionCallback<List<ConfigInfo>>() {
                    final Timestamp time = new Timestamp(System.currentTimeMillis());
        ...
        try {
            ...
            return this.jt.queryForObject(
                ...
                EmptyResultDataAccessException
                        e) { // Indicates that the data does not exist, returns null.
            return null;
        } catch (CannotGetJdbcConnectionException e) {
            LogUtil.FATAL_LOG.error("[db-error] " + e.toString(), e);
            throw e;
    ...
    public Page<ConfigInfoBase> findConfigInfoBaseByGroup(
        ...
        try {
            ...
            MapperResult mapperResult =
                    configInfoMapper.findConfigInfoBaseByGroupFetchRows(context);
    ...
    public List<String> getTenantIdList(int page, int pageSize) {
        ...
        return jt.queryForList(
                mapperResult.getSql(), mapperResult.getParamList().toArray(), String.class);
    }
    ...
    public Page<ConfigInfo> findAllConfigInfo(
        ...
        ConfigInfoMapper configInfoMapper =
                mapperManager.findMapper(
                        dataSourceService.getDataSourceType(), TableConstant.CONFIG_INFO);
        MapperContext context = new MapperContext(startRow, pageSize);
        context.putWhereParameter(
                FieldConstant.TENANT_ID, generateLikeArgument(generateLikeArgument(tenantTmp)));
    ...
    public List<ConfigInfoWrapper> findChangeConfig(
        ...
        try {
            ...
            List<Map<String, Object>> list =
                    jt.queryForList(mapperResult.getSql(), mapperResult.getParamList().toArray());
    ...
    public Page<ConfigHistoryInfo> findConfigHistory(
        ...
        try {
            ...
            LogUtil.FATAL_LOG.error(
                    "[list-config-history] error, dataId:{}, group:{}",
    ...
    public ConfigHistoryInfo detailConfigHistory(Long nid) {
        ...
        try {
            ConfigHistoryInfo historyInfo =
                    jt.queryForObject(sqlFetchRows, new Object[] {nid}, HISTORY_DETAIL_ROW_MAPPER);
            return historyInfo;
        } catch (DataAccessException e) {
    ...
    public ConfigHistoryInfo detailPreviousConfigHistory(Long id) {
        ...
        try {
            ...
            LogUtil.FATAL_LOG.error(
                    "[detail-previous-config-history] error, id:{}", new Object[] {id}, e);
            throw e;
        }
    }
