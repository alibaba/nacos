...
public class PropertyUtil {
     ...
     * 单机模式使用db
     */
    private static boolean standaloneUseDb = false;
    ...
    public void init() {
        try {
            ...
            setStandaloneUseDb(getString("spring.datasource.platform", "").equals("mysql"));
    ...
    public static boolean isStandaloneUseDb() {
        return standaloneUseDb;
    }
    ...
    public static void setStandaloneUseDb(boolean standaloneUseDb) {
        PropertyUtil.standaloneUseDb = standaloneUseDb;
    }
}
