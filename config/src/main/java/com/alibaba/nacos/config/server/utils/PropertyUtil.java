...
public class PropertyUtil implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    ...
    /**
     * Whether to enable the limit check function of capacity management,
     * including the upper limit of configuration number, configuration content size limit, etc.
     */
