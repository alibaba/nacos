...
/**
 * Generic classes for wildcard characters, decisions,
 * and standard canonical transformations that can be supported by ConfigCenter.
 *
...
public class RegexParser {
     ...
     * Replace '*' with '.* '? 'is replaced by '{n}', n is the number of consecutive ?;
     * Other special characters that are not alphabetic or numeric are preceded by '\'.
     *
     * @param regex regex
     * @return
     */
