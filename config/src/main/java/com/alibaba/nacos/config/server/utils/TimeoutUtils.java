 ...
 * After obtaining the data from the network,totalTime is accumulated.
 * Before obtaining the data from the network, check whether the totalTime is greater than totalTimeout.
 * If yes, it indicates the totalTimeout
 *
 * @author leiwen.zh
 */
