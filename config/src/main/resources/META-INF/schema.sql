...
INSERT INTO tenant_info (id, kp, tenant_id, tenant_name, tenant_desc, create_source, gmt_create, gmt_modified) VALUES (1, 1, 'public', 'public', 'default', 'nacos', UNIX_TIMESTAMP() * 1000, UNIX_TIMESTAMP() * 1000)
