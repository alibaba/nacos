...
public class ConfigControllerTest {
    ...
    @Mock private ConfigServletInner inner;
    ...
    @Mock private ConfigOperationService configOperationService;

    @Mock private ConfigSubService configSubService;
    ...
    public void setUp() {
        ...
        ReflectionTestUtils.setField(
                configController, "configInfoPersistService", configInfoPersistService);
        ReflectionTestUtils.setField(
                configController, "configInfoBetaPersistService", configInfoBetaPersistService);
        ReflectionTestUtils.setField(
                configController, "namespacePersistService", namespacePersistService);
        ReflectionTestUtils.setField(
                configController, "configOperationService", configOperationService);
    ...
    public void testPublishConfig() throws Exception {
        ...
        MockHttpServletRequestBuilder builder =
                MockMvcRequestBuilders.post(Constants.CONFIG_CONTROLLER_PATH)
                        .param("dataId", "test")
                        .param("group", "test")
                        .param("tenant", "")
                        .param("content", "test")
    ...
    public void testGetConfig() throws Exception {
        MockHttpServletRequestBuilder builder =
                MockMvcRequestBuilders.get(Constants.CONFIG_CONTROLLER_PATH)
                        .param("dataId", "test")
                        .param("group", "test")
                        .param("tenant", "")
                        .param("tag", "");
    ...
    public void testDetailConfigInfo() throws Exception {
        ...
        when(configInfoPersistService.findConfigAllInfo("test", "test", ""))
    ...
    public void testDeleteConfig() throws Exception {
        ...
        MockHttpServletRequestBuilder builder =
                MockMvcRequestBuilders.delete(Constants.CONFIG_CONTROLLER_PATH)
                        .param("dataId", "test")
                        .param("group", "test")
                        .param("tenant", "")
                        .param("tag", "");
    ...
    public void testGetConfigAdvanceInfo() throws Exception {
        ...
        when(configInfoPersistService.findConfigAdvanceInfo("test", "test", ""))
                .thenReturn(configAdvanceInfo);

        MockHttpServletRequestBuilder builder =
                MockMvcRequestBuilders.get(Constants.CONFIG_CONTROLLER_PATH + "/catalog")
                        .param("dataId", "test")
                        .param("group", "test")
                        .param("tenant", "");
        ...
        Assert.assertEquals(
                configAdvanceInfo.getCreateUser(), resConfigAdvanceInfo.getCreateUser());
    ...
    public void testListener() throws Exception {
        MockHttpServletRequestBuilder builder =
                MockMvcRequestBuilders.post(Constants.CONFIG_CONTROLLER_PATH + "/listener")
    ...
    public void testGetListeners() throws Exception {
        ...
        when(configSubService.getCollectSampleResult("test", "test", "", 1))
                .thenReturn(sampleResult);

        MockHttpServletRequestBuilder builder =
                MockMvcRequestBuilders.get(Constants.CONFIG_CONTROLLER_PATH + "/listener")
                        .param("dataId", "test")
                        .param("group", "test")
                        .param("tenant", "")
                        .param("sampleTime", "1");
        ...
        GroupkeyListenserStatus groupkeyListenserStatus =
                JacksonUtils.toObj(actualValue, GroupkeyListenserStatus.class);
        ...
        Assert.assertEquals(
                "test", groupkeyListenserStatus.getLisentersGroupkeyStatus().get("test"));
    }
    ...
    public void testSearchConfig() throws Exception {
        ...
        when(configInfoPersistService.findConfigInfo4Page(
                        1, 10, "test", "test", "", configAdvanceInfo))
                .thenReturn(page);
        ...
        ConfigInfo resConfigInfo =
                JacksonUtils.toObj(pageItemsNode.get(0).toString(), ConfigInfo.class);
    ...
    public void testFuzzySearchConfig() throws Exception {
        ...
        when(configInfoPersistService.findConfigInfoLike4Page(
                        1, 10, "test", "test", "", configAdvanceInfo))
                .thenReturn(page);
        ...
        List resultList =
                JacksonUtils.toObj(
                        JacksonUtils.toObj(actualValue).get("pageItems").toString(), List.class);
        ConfigInfo resConfigInfo =
                JacksonUtils.toObj(
                        JacksonUtils.toObj(actualValue).get("pageItems").get(0).toString(),
                        ConfigInfo.class);
    ...
    public void testQueryBeta() throws Exception {
        ...
        when(configInfoBetaPersistService.findConfigInfo4Beta("test", "test", ""))
        ...
        String code = JacksonUtils.toObj(actualValue).get("code").toString();
        String data = JacksonUtils.toObj(actualValue).get("data").toString();
        ConfigInfoBetaWrapper resConfigInfoBetaWrapper =
                JacksonUtils.toObj(data, ConfigInfoBetaWrapper.class);

        Assert.assertEquals("200", code);
        Assert.assertEquals(
                configInfoBetaWrapper.getDataId(), resConfigInfoBetaWrapper.getDataId());
        Assert.assertEquals(configInfoBetaWrapper.getGroup(), resConfigInfoBetaWrapper.getGroup());
        Assert.assertEquals(
                configInfoBetaWrapper.getContent(), resConfigInfoBetaWrapper.getContent());
    }
    ...
    public void testImportAndPublishConfig() throws Exception {
        ...
        MockHttpServletRequestBuilder builder =
                MockMvcRequestBuilders.multipart(Constants.CONFIG_CONTROLLER_PATH)
                        .file(file)
                        .param("import", "true")
                        .param("src_user", "test")
        ...
        Map<String, Object> resultMap =
                JacksonUtils.toObj(
                        JacksonUtils.toObj(actualValue).get("data").toString(), Map.class);
    ...
    public void testCloneConfig() throws Exception {
        ...
        MockHttpServletRequestBuilder builder =
                MockMvcRequestBuilders.post(Constants.CONFIG_CONTROLLER_PATH)
                        ...
                        .param("tenant", "public")
                        .param("policy", "ABORT")
                        .content(JacksonUtils.toJson(configBeansList))
