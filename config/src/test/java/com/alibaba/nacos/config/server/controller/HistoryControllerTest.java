...
public class HistoryControllerTest {
    ...
    @InjectMocks HistoryController historyController;
    ...
    public void testListConfigHistory() throws Exception {
        ...
        MockHttpServletRequestBuilder builder =
                MockMvcRequestBuilders.get(Constants.HISTORY_CONTROLLER_PATH)
        ...
        ConfigHistoryInfo resConfigHistoryInfo =
                JacksonUtils.toObj(pageItemsNode.get(0).toString(), ConfigHistoryInfo.class);
    ...
    public void testGetConfigHistoryInfo() throws Exception {
        ...
        when(historyController.getConfigHistoryInfo("test", "test", "", 1L))
        ...
        String actualValue =
                mockmvc.perform(builder).andReturn().getResponse().getContentAsString();
        ConfigHistoryInfo resConfigHistoryInfo =
                JacksonUtils.toObj(actualValue, ConfigHistoryInfo.class);
    ...
    public void testGetPreviousConfigHistoryInfo() throws Exception {
        ...
        when(historyService.getPreviousConfigHistoryInfo("test", "test", "", 1L))
                .thenReturn(configHistoryInfo);

        MockHttpServletRequestBuilder builder =
                MockMvcRequestBuilders.get(Constants.HISTORY_CONTROLLER_PATH + "/previous")
                        .param("dataId", "test")
                        .param("group", "test")
                        .param("tenant", "")
                        .param("id", "1");
    ...
    public void testGetDataIds() throws Exception {
        ...
        MockHttpServletRequestBuilder builder =
                MockMvcRequestBuilders.get(Constants.HISTORY_CONTROLLER_PATH + "/configs")
                        .param("tenant", "test");

        String actualValue =
                mockmvc.perform(builder).andReturn().getResponse().getContentAsString();
        List resConfigInfoWrappers = JacksonUtils.toObj(actualValue, List.class);
        ConfigInfoWrapper resConfigInfoWrapper =
                JacksonUtils.toObj(
                        JacksonUtils.toObj(actualValue).get(0).toString(), ConfigInfoWrapper.class);
