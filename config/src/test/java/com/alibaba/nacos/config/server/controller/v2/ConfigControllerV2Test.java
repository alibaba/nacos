...
public class ConfigControllerV2Test {
    ...
    public void setUp() {
        ...
        configControllerV2 =
                new ConfigControllerV2(inner, configOperationService, configDetailService);
    ...
    public void testGetConfig() throws Exception {
        ...
        doAnswer(
                        x -> {
                            ...
                            x.getArgument(1, HttpServletResponse.class)
                                    .getWriter()
                                    .print(JacksonUtils.toJson(stringResult));
                            return null;
                        })
                .when(inner)
                .doGetConfig(
                        ...
                        eq(TEST_DATA_ID),
                        eq(TEST_GROUP),
                        eq(TEST_NAMESPACE_ID),
                        eq(TEST_TAG),
                        eq(null),
                        anyString(),
                        eq(true));

        configControllerV2.getConfig(
                request, response, TEST_DATA_ID, TEST_GROUP, TEST_NAMESPACE_ID, TEST_TAG);
    ...
    public void testPublishConfig() throws Exception {
        ...
        when(configOperationService.publishConfig(
                        any(ConfigForm.class), any(ConfigRequestInfo.class), anyString()))
                .thenReturn(true);

        Result<Boolean> booleanResult = configControllerV2.publishConfig(configForm, request);

        verify(configOperationService)
        ...
        when(configOperationService.publishConfig(
                ...
                .thenAnswer(
                        (Answer<Boolean>)
                                invocation -> {
                                    if (invocation
                                            .getArgument(0, ConfigForm.class)
                                            .getNamespaceId()
                                            .equals(TEST_NAMESPACE_ID)) {
                                        return true;
                                    }
                                    return false;
                                });
    ...
    public void testDeleteConfigWhenNameSpaceIsPublic() throws Exception {
        ...
        Result<Boolean> booleanResult =
                configControllerV2.deleteConfig(
                        request, TEST_DATA_ID, TEST_GROUP, TEST_NAMESPACE_ID_PUBLIC, TEST_TAG);
    ...
    public void testDeleteConfig() throws Exception {
        ...
        Result<Boolean> booleanResult =
                configControllerV2.deleteConfig(
                        request, TEST_DATA_ID, TEST_GROUP, TEST_NAMESPACE_ID, TEST_TAG);
    ...
    public void testGetConfigByDetail() throws Exception {
        ...
        MockHttpServletRequestBuilder builder =
                MockMvcRequestBuilders.get(Constants.CONFIG_CONTROLLER_V2_PATH + "/searchDetail")
