...
public class HistoryControllerV2Test {
    ...
    public void testListConfigHistory() throws Exception {
        ...
        when(historyService.listConfigHistory(TEST_DATA_ID, TEST_GROUP, TEST_NAMESPACE_ID, 1, 10))
                .thenReturn(page);

        Result<Page<ConfigHistoryInfo>> pageResult =
                historyControllerV2.listConfigHistory(
                        TEST_DATA_ID, TEST_GROUP, TEST_NAMESPACE_ID, 1, 10);
    ...
    public void testListConfigHistoryWhenNameSpaceIsPublic() throws Exception {
        ...
        Result<Page<ConfigHistoryInfo>> pageResult =
                historyControllerV2.listConfigHistory(
                        TEST_DATA_ID, TEST_GROUP, TEST_NAMESPACE_ID_PUBLIC, 1, 10);
    ...
    public void testGetConfigHistoryInfoWhenNameSpaceIsPublic() throws Exception {
        ...
        Result<ConfigHistoryInfo> result =
                historyControllerV2.getConfigHistoryInfo(
                        TEST_DATA_ID, TEST_GROUP, TEST_NAMESPACE_ID_PUBLIC, 1L);
    ...
    public void testGetConfigHistoryInfo() throws Exception {
        ...
        Result<ConfigHistoryInfo> result =
                historyControllerV2.getConfigHistoryInfo(
                        TEST_DATA_ID, TEST_GROUP, TEST_NAMESPACE_ID, 1L);
    ...
    public void testGetPreviousConfigHistoryInfo() throws Exception {
        ...
        when(historyService.getPreviousConfigHistoryInfo(
                        TEST_DATA_ID, TEST_GROUP, TEST_NAMESPACE_ID, 1L))
                .thenReturn(configHistoryInfo);

        Result<ConfigHistoryInfo> result =
                historyControllerV2.getPreviousConfigHistoryInfo(
                        TEST_DATA_ID, TEST_GROUP, TEST_NAMESPACE_ID, 1L);
    ...
    public void testGetConfigListByNamespaceWhenIsPublic() throws NacosApiException {
        ...
        when(historyService.getConfigListByNamespace(TEST_NAMESPACE_ID))
                .thenReturn(configInfoWrappers);
        Result<List<ConfigInfoWrapper>> result =
                historyControllerV2.getConfigsByTenant(TEST_NAMESPACE_ID_PUBLIC);
