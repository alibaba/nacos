...
public class RpcConfigChangeNotifierTest {
    ...
    @Mock private ConfigChangeListenContext configChangeListenContext;

    @Mock private RpcPushService rpcPushService;
    ...
    public void setUp() {
        ...
        ReflectionTestUtils.setField(
                rpcConfigChangeNotifier, "configChangeListenContext", configChangeListenContext);
        ReflectionTestUtils.setField(rpcConfigChangeNotifier, "rpcPushService", rpcPushService);
        ReflectionTestUtils.setField(
                rpcConfigChangeNotifier, "connectionManager", connectionManager);
    }
    ...
    public void testOnEvent() {
        ...
        final String limitGroupKey =
                GroupKey2.getKey(
                        "nacos.internal.tps.nacos.internal.connection.limit.rule",
                        "nacos",
                        "tenant");
