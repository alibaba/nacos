...
public class HistoryServiceTest {
    ...
    public void setUp() throws Exception {
        this.historyService =
                new HistoryService(historyConfigInfoPersistService, configInfoPersistService);
    }
    ...
    public void testListConfigHistory() {
        ...
        when(historyConfigInfoPersistService.findConfigHistory(
                        TEST_DATA_ID, TEST_GROUP, TEST_TENANT, 1, 10))
                .thenReturn(page);

        Page<ConfigHistoryInfo> pageResult =
                historyService.listConfigHistory(TEST_DATA_ID, TEST_GROUP, TEST_TENANT, 1, 10);

        verify(historyConfigInfoPersistService)
                .findConfigHistory(TEST_DATA_ID, TEST_GROUP, TEST_TENANT, 1, 10);
    ...
    public void testGetPreviousConfigHistoryInfo() throws Exception {
        ...
        ConfigHistoryInfo resConfigHistoryInfo =
                historyService.getPreviousConfigHistoryInfo(
                        TEST_DATA_ID, TEST_GROUP, TEST_TENANT, 1L);
