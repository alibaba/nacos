...
public class TenantCapacityPersistServiceTest {
    ...
    @InjectMocks private TenantCapacityPersistService service;
    ...
    public void setUp() {
        ...
        doReturn(new TenantCapacityMapperByMySql())
                .when(mapperManager)
    ...
    public void testGetTenantCapacity() {
        ...
        when(jdbcTemplate.query(anyString(), eq(new Object[] {tenantId}), any(RowMapper.class)))
                .thenReturn(list);
