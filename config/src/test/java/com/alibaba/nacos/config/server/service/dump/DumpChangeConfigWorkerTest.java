...
class DumpChangeConfigWorkerTest {
    ...
    void init() throws Exception {
        ...
        dumpChangeConfigWorker = new DumpChangeConfigWorker(configInfoPersistService,
    ...
    void testDumpChangeOfDeleteConfigs() {
        ...
        assertEquals("encrykey" + 1,
                ConfigCacheService
                        .getContentCache(
                                GroupKey.getKeyTenant(dataIdPrefix + 1, "group" + 1, "tenant" + 1))
                        .getConfigCache()
                        .getEncryptedDataKey());
        ...
        Mockito.when(configInfoPersistService.findConfigInfoState(eq(dataIdPrefix + 1),
                eq("group" + 1), eq("tenant" + 1)))
                .thenReturn(null);
        Mockito.when(configInfoPersistService.findConfigInfoState(eq(dataIdPrefix + 2),
        ...
        assertNull(ConfigCacheService.getContentCache(
                GroupKey.getKeyTenant(dataIdPrefix + 1, "group" + 1, "tenant" + 1)));
    }
    ...
    void testDumpChangeOfChangedConfigsNewTimestampOverride() {
        ...
        Mockito.when(configInfoPersistService.findConfigInfo(eq(dataIdPrefix + 1), eq("group" + 1),
                eq("tenant" + 1)))
