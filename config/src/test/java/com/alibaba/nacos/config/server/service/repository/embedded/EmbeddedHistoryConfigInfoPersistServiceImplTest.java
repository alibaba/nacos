...
class EmbeddedHistoryConfigInfoPersistServiceImplTest {
    ...
    void testFindConfigHistory() {
        ...
        Mockito.when(
                databaseOperate.queryMany(anyString(), eq(new Object[] {dataId, group, tenant}),
    ...
    void testDetailConfigHistory() {
        ...
        Mockito.when(databaseOperate.queryOne(anyString(), eq(new Object[] {nid}),
                eq(HISTORY_DETAIL_ROW_MAPPER)))
    ...
    void testFindConfigHistoryCountByTime() {
        ...
        //mock count
        Mockito.when(databaseOperate.queryOne(anyString(), eq(new Object[] {timestamp}),
                eq(Integer.class)))
                .thenReturn(308);
        //execute & verify
