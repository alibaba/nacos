...
/**
 * Has nothing to do with the specific implementation of the consistency protocol Initialization
 * sequence： init(Config).
 *
 * <ul>
 ...
 *       the Log is stored, and the snapshot task execution interval
 *   <li>{@link ConsistencyProtocol#protocolMetaData()} : Returns metadata information of the
 *       consistency protocol, such as leader, term, and other metadata information in the Raft
 *       protocol
 * </ul>
 *
