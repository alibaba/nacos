...
const I18N_CONF = {
  ...
  SettingCenter: {
    ...
    copilotConnectionTest: 'Test Connection',
    copilotConnectionTestHint:
      'The test result shows whether the current configuration is ready to use.',
    copilotConnectionTestSuccess: 'Connection test passed',
    copilotConnectionTestFailed: 'Connection test failed',
    copilotConnectionConfigStatus: 'Config Check',
    copilotConnectionConfigValid: 'Passed',
    copilotConnectionConfigInvalid: 'Failed',
    copilotConnectionLlmStatus: 'LLM Reachability',
    copilotConnectionLlmReachable: 'Reachable',
    copilotConnectionLlmUnreachable: 'Unreachable',
    copilotConnectionApiKeySource: 'API Key Source',
    copilotConnectionApiKeySourceEnv: 'Environment Variable',
    copilotConnectionApiKeySourceConfig: 'Page Config',
    copilotConnectionApiKeySourceNone: 'Not Configured',
    copilotConnectionStudioStatus: 'Studio Config',
    copilotConnectionStudioConfigured: 'Configured',
    copilotConnectionStudioNotConfigured: 'Not Configured',
  },
  AgentManagement: {
    agentManagement: 'Agent Management',
