...
const I18N_CONF = {
  ...
  SettingCenter: {
    ...
    settingSubmit: 'Apply',
    copilotConfigSection: 'Nacos Copilot Configuration',
    ...
    copilotLlmApiKeyPlaceholder: 'Please enter API Key',
  ...
  SkillManagement: {
    ...
    create: 'Create',
    cancel: 'Cancel',
    skillNamePlaceholder: 'Please enter Skill name',
    ...
    optimizationGoalPlaceholder: 'Enter optimization goal (optional), e.g., improve instruction clarity, add error handling, add resource templates',
    optimizeHint: 'Enter optimization goal and click Start Optimization, AI will optimize the Skill content based on the goal',
    ...
    backgroundInfoPlaceholder: 'Please describe what you want the Skill to do, e.g., "I need a Skill to check Nacos configuration status and provide solutions when issues are found"',
    generateSkill: 'Generate Skill',
    generateHint: 'Enter background information and click to generate a Skill based on best practices',
    ...
    conversationHistoryPlaceholder: 'Enter conversation history in JSON format:\n{\n  "title": "Conversation Title",\n  "context": "Context description",\n  "messages": [\n    {\n      "type": "user",\n      "content": "User input"\n    },\n    {\n      "type": "tool_call",\n      "toolName": "tool_name",\n      "toolInput": {"param": "value"},\n      "toolOutput": "result"\n    },\n    {\n      "type": "model",\n      "content": "Model response"\n    }\n  ]\n}',
    conversationHistoryHint: 'The system will analyze the conversation history to determine if it is suitable for skill generation/optimization. Include user inputs, tool calls, and model responses.',
