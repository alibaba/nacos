...
const I18N_CONF = {
  ...
  HistoryRollback: {
    ...
    rollback: 'Roll Back',
    pubNoData: 'No results found.',
    toConfigure: 'Historical Versions (Configuration record is retained for latest 10.)',
    ...
    operation: 'Operation',
    compare: 'Compare',
    queryResult: 'Query Result: Total',
    articleMeet: 'Match Condition Config',
    opTypeDesc: 'Operation Type',
  ...
  ConfigurationManagement: {
    ...
    noAppPermission: 'No app permission',
  ...
  NewConfig: {
    ...
    tags: 'Tags',
    appNameNotEmpty: 'App name not empty',
    pleaseEnterTag: 'Enter Tag',
  ...
  NewUser: {
    ...
    type: 'User Type',
    typeError: 'User Type not empty',
    typePlaceholder: 'Please chose user type',
    personAccount: 'Person Account',
    appAccount: 'App Account',
  },
  PasswordReset: {
  ...
  NewPermissions: {
    ...
    readWrite: 'Read and write',
    appName: 'AppName',
    appNameError: 'AppName not empty',
    appNamePlaceholder: 'Please chose AppName',
  },
  Components: {
