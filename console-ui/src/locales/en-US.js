...
const I18N_CONF = {
  ...
  AgentManagement: {
    ...
    supportsStreaming: 'Supports streaming data transmission',
    supportsPushNotifications: 'Supports push notification feature',
    supportsStateHistory: 'Supports recording state transition history',
    // Status
    enabled: 'Enabled',
    disabled: 'Disabled',
    enableStatus: 'Enable',
    ...
    // Sections
    capabilitiesSection: 'Capabilities Configuration',
    securityScheme: 'Security Scheme',
    securityConfiguration: 'Security Configuration',
    additionalInterface: 'Additional Interface',
    // Messages
    agentNameRequired: 'Agent name cannot be empty',
    getAgentDetailFailed: 'Failed to get Agent details',
    ...
    updateTimeField: 'Update Time',
    // Agent Details
    agentDetails: 'Agent Details',
    agentNotExist: 'Agent does not exist or has been deleted',
    backToList: 'Back to List',
    editButton: 'Edit',
    // Additional field labels
    providerName: 'Provider Name',
    providerUrl: 'Provider URL',
    supportAuthExtendedCard: 'Support Auth Extended Card',
  },
  McpServerManagement: {
  ...
  McpDetail: {
    ...
    arrayItemProperties: 'Array Item Properties',
    arrayItemDefinition: 'Array Item Definition',
    arrayItemInfo: 'Array Item Info',
    typeLabel: 'Type:',
    descriptionLabel: 'Description:',
    formatLabel: 'Format:',
    ...
    packageParameters: 'Package Parameters',
    positionalArgs: 'Positional Arguments',
    ...
    protocolTransformConfig: 'Protocol Transformation Configuration',
    transparentAuthInfo: 'Transparent Authentication Information',
    enabledStatus: 'Enabled Status:',
    statusEnabled: 'Enabled',
    statusDisabled: 'Disabled',
    clientAuthMethod: 'Client Authentication Method:',
    requestTemplateConfig: 'Request Template Configuration',
    httpMethod: 'HTTP Method:',
    requestPath: 'Request Path:',
    backendAuthMethod: 'Backend Authentication Method:',
    responseTemplateConfig: 'Response Template Configuration',
    responseBodyTemplate: 'Response Body Template',
    responsePrefix: 'Response Prefix',
    responseSuffix: 'Response Suffix',
    otherConfig: 'Other Configuration:',
    noResponseTemplate: 'No response template configuration',
  ...
  SchemaEditor: {
    ...
    confirmDeleteMessage: 'Are you sure you want to delete this item and all its children?',
    parameterTree: 'Parameter Tree',
    addParameter: 'Add Parameter',
    addProperty: 'Add Property',
    readOnlyMode: 'Read-only mode, cannot edit',
    parameterDetails: 'Parameter Details',
    stringType: 'String type (string)',
    numberType: 'Number type (number)',
    integerType: 'Integer type (integer)',
    booleanType: 'Boolean type (boolean)',
    ...
    enterParameterDescription: 'Please enter parameter description',
    required: 'Required',
    requiredField: 'Required',
    optional: 'Optional',
    defaultValue: 'Default Value',
    enterNumber: 'Please enter a number',
    defaultValueHint: 'Optional: Set a default value for this parameter',
    selectDefaultValue: 'Please select default value',
    enterNumberDefault: 'Please enter numeric default value',
    enterDefaultValue: 'Please enter default value',
  },
  CreateTools: {
    protocolTransformation: 'Protocol transformation via gateway template',
    configurationDetails: 'Configuration Options Details',
    requestBodyConfig: 'Request Body Configuration',
    argsPositionConfig: 'Arguments Position Configuration',
    responseHandlingConfig: 'Response Processing Configuration',
    argsPositionDescription: 'Arguments Position Description',
    configTemplateGenerator: 'Configuration Template Generator',
    jsonRequestBody: 'JSON Request Body',
    urlParams: 'URL Parameters',
    formData: 'Form Data',
    customRequestBody: 'Custom Request Body',
    argsPositionPath: 'Arguments Position - Path',
    enableTransparentAuth: 'Enable Transparent Auth',
    security: 'Security',
    enableDisable: 'Enable/Disable',
    authInfoTransparent: 'Authentication info will be transparently passed',
    authSchemeConfig: 'Authentication Scheme Configuration',
    backendAuthMethod: 'Backend Authentication Method',
    selectAuthScheme: 'Please select authentication scheme',
    clientAuthMethod: 'Client Authentication Method',
    requestTemplateUrlRequired: 'requestTemplate.url is a required field',
    requestTemplateMethodRequired: 'requestTemplate.method is a required field',
    fieldsMutuallyExclusive: 'Fields are mutually exclusive, only one can be selected',
    argsPositionMustBeObject: 'argsPosition must be an object',
    mcpServersOnlyOneElement: 'mcpServers can only contain one element',
    responseBodyMutuallyExclusive:
      'responseTemplate body is mutually exclusive with prependBody/appendBody',
    templateFormatError: 'Template format error, please enter valid JSON format',
  },
  ShowTools: {
    descriptionField: 'Description',
    defaultValue: 'Default Value',
  ...
  ImportMcpDialog: {
    enterImportData: 'Please enter import data',
    validationFailed: 'Validation failed',
    noServicesToImport: 'No services to import',
    selectServicesFirst: 'Please select services to import first',
    ...
    loading: 'Loading...',
    searchByNameKeyword: 'Search by name keyword (fuzzy)',
    clear: 'Clear',
    search: 'Search',
  ...
  Common: {
    operationNotAvailable: 'This operation is not available',
