...
const I18N_CONF = {
  ...
  PromptManagement: {
    ...
    offlineSuccess: '下线成功',
    offlineFailed: '下线失败',
    redraftSuccess: '重新编辑成功，版本已变为草稿',
    redraftFailed: '重新编辑失败',
  ...
  SkillManagement: {
    ...
    dropZipHere: '拖拽 .zip 文件到此处上传 Skill',
    skillsUploadedSuccessfully: '个 Skill 上传成功',
    dragDropHint: '支持拖拽 .zip 文件到此页面上传',
    ...
    getSkillSubscriptionsFailed: '获取Skill订阅列表失败',
    noSkillSubscriptions: '暂无Skill订阅',
    selectSkillToSubscribe: '请先选择要订阅的Skill',
    skillName: '名称',
    skillId: 'Skill ID',
    search: '搜索',
    bizTag: '业务标签',
    ...
    labelExists: '标签已存在',
    latestLabelReserved: 'latest 由服务端维护',
