...
const I18N_CONF = {
  ...
  AgentManagement: {
    ...
    stateHistory: '状态历史',
    supportsStreaming: '是否支持流式数据传输',
    supportsPushNotifications: '是否支持推送通知功能',
    supportsStateHistory: '是否支持记录状态转换历史',
    // Status
    enabled: '开启',
    disabled: '关闭',
    enableStatus: '启用',
    disableStatus: '禁用',
    // Sections
    capabilitiesSection: '能力配置',
    securityScheme: '安全方案',
    securityConfiguration: '安全配置',
    additionalInterface: '附加接口',
    // Messages
    agentNameRequired: 'Agent名称不能为空',
    getAgentDetailFailed: '获取Agent详情失败',
    ...
    agentNotExist: 'Agent不存在或已被删除',
    backToList: '返回列表',
    editButton: '编辑',
    // Additional field labels
    providerName: '提供商名称',
    providerUrl: '提供商URL',
    supportAuthExtendedCard: '支持认证扩展卡',
  },
  McpServerManagement: {
  ...
  McpDetail: {
    ...
    arrayItemProperties: '数组项属性',
    arrayItemDefinition: '数组项定义',
    arrayItemInfo: '数组项信息',
    typeLabel: '类型:',
    descriptionLabel: '描述:',
    formatLabel: '格式:',
    ...
    parametersCount: '个参数',
    outputConfig: '出参配置',
    protocolTransformConfig: '协议转化配置',
    transparentAuthInfo: '透明认证信息',
    enabledStatus: '启用状态:',
    statusEnabled: '已启用',
    statusDisabled: '未启用',
    clientAuthMethod: '客户端认证方式:',
    requestTemplateConfig: '请求模板配置',
    httpMethod: 'HTTP 方法:',
    requestPath: '请求路径:',
    backendAuthMethod: '后端认证方式:',
    responseTemplateConfig: '响应模板配置',
    responseBodyTemplate: '响应体模板',
    responsePrefix: '响应前缀',
    responseSuffix: '响应后缀',
    otherConfig: '其他配置:',
    noResponseTemplate: '暂无响应模板配置',
    noAvailableTools: '暂无可用的 Tools',
  },
  NewMcpServer: {
  ...
  SchemaEditor: {
    confirmDelete: '确认删除',
    confirmDeleteMessage: '确定要删除此项及其所有子项吗？',
    parameterTree: '参数树',
    addParameter: '增加参数',
    addProperty: '增加属性',
    readOnlyMode: '只读模式不可编辑',
    parameterDetails: '参数详情',
    stringType: '字符串类型 (string)',
    numberType: '数字类型 (number)',
    integerType: '整数类型 (integer)',
    booleanType: '布尔类型 (boolean)',
    arrayType: '数组类型 (array)',
    objectType: '对象类型 (object)',
    enterParameterName: '请输入参数名称',
    selectParameterType: '请选择参数类型',
    enterParameterDescription: '请输入参数描述信息',
    required: '是否必填',
    requiredField: '必填',
    optional: '可选',
    defaultValue: '默认值',
    enterNumber: '请输入数字',
    defaultValueHint: '可选：为此参数设置默认值',
    selectDefaultValue: '请选择默认值',
    enterNumberDefault: '请输入数字默认值',
    enterDefaultValue: '请输入默认值',
  },
  CreateTools: {
    protocolTransformation: '通过网关提供的协议转化模版进行协议转化',
    configurationDetails: '配置选项详细说明',
    requestBodyConfig: '请求体配置',
    argsPositionConfig: '参数位置配置',
    responseHandlingConfig: '响应处理配置',
    argsPositionDescription: '参数位置说明',
    configTemplateGenerator: '配置模板生成器',
    jsonRequestBody: 'JSON请求体',
    urlParams: 'URL参数',
    formData: '表单数据',
    customRequestBody: '自定义请求体',
    argsPositionPath: '参数位置-Path',
    enableTransparentAuth: '启用透明认证',
    security: '安全',
    enableDisable: '启用/禁用',
    authInfoTransparent: '认证信息将透明传递',
    authSchemeConfig: '认证方案配置',
    backendAuthMethod: '后端认证方式',
    selectAuthScheme: '请选择认证方案',
    clientAuthMethod: '客户端认证方式',
    requestTemplateUrlRequired: 'requestTemplate.url 是必填字段',
    requestTemplateMethodRequired: 'requestTemplate.method 是必填字段',
    fieldsMutuallyExclusive: '字段互斥，只能选择一个',
    argsPositionMustBeObject: 'argsPosition 必须是一个对象',
    mcpServersOnlyOneElement: 'mcpServers 只能包含一个元素',
    responseBodyMutuallyExclusive: 'responseTemplate 中 body 与 prependBody/appendBody 互斥',
    templateFormatError: '模板格式错误，请输入有效的 JSON 格式',
  },
  ShowTools: {
    descriptionField: '描述',
    defaultValue: '默认值',
  ...
  ImportMcpDialog: {
    enterImportData: '请输入导入数据',
    validationFailed: '校验失败',
    noServicesToImport: '暂无可导入的服务',
    selectServicesFirst: '请先选择要导入的服务',
    importResult: '导入结果',
    success: '成功',
    failed: '失败',
    reason: '原因',
    ...
    importAll: '导入全部',
    loading: '加载中...',
    searchByNameKeyword: '按名称关键词搜索（模糊）',
    clear: '清除',
    search: '搜索',
    noMatchingResults: '未找到匹配的结果',
    clearSearchAndRetry: '清空搜索并重试',
    detail: '详情',
    serviceType: '服务类型',
    imported: '已导入',
    loadMore: '加载更多',
