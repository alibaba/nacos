...
const I18N_CONF = {
  ...
  SettingCenter: {
    ...
    copilotConnectionTest: '检测连接',
    copilotConnectionTestHint: '检测结果将展示当前配置是否可用。',
    copilotConnectionTestSuccess: '连接检测通过',
    copilotConnectionTestFailed: '连接检测失败',
    copilotConnectionConfigStatus: '配置检查',
    copilotConnectionConfigValid: '通过',
    copilotConnectionConfigInvalid: '未通过',
    copilotConnectionLlmStatus: 'LLM连通性',
    copilotConnectionLlmReachable: '可访问',
    copilotConnectionLlmUnreachable: '不可访问',
    copilotConnectionApiKeySource: 'API Key来源',
    copilotConnectionApiKeySourceEnv: '环境变量',
    copilotConnectionApiKeySourceConfig: '页面配置',
    copilotConnectionApiKeySourceNone: '未配置',
    copilotConnectionStudioStatus: 'Studio配置',
    copilotConnectionStudioConfigured: '已配置',
    copilotConnectionStudioNotConfigured: '未配置',
  },
  AgentManagement: {
