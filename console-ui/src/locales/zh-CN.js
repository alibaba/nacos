...
const I18N_CONF = {
  ...
  SkillManagement: {
    ...
    optimizationGoalPlaceholder: '请输入优化目标（可选），例如：优化指令的清晰度、添加错误处理逻辑、增加资源模板等',
    ...
    backgroundInfo: '背景信息',
    backgroundInfoPlaceholder: '请描述您希望Skill实现的功能，例如："我需要一个Skill来检查Nacos配置状态，并在发现问题时提供解决方案"',
    ...
    conversationHistoryPlaceholder: '请输入对话历史的 JSON 格式：\n{\n  "title": "对话主题",\n  "context": "对话上下文描述",\n  "messages": [\n    {\n      "type": "user",\n      "content": "用户输入"\n    },\n    {\n      "type": "tool_call",\n      "toolName": "工具名称",\n      "toolInput": {"param": "value"},\n      "toolOutput": "结果"\n    },\n    {\n      "type": "model",\n      "content": "模型回复"\n    }\n  ]\n}',
    conversationHistoryHint: '系统将分析对话历史，判断是否适合生成或优化 Skill。请包含用户输入、工具调用和模型回复。',
