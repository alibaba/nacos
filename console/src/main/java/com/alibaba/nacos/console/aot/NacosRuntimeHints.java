...
public class NacosRuntimeHints implements RuntimeHintsRegistrar {
    ...
    // region gRpc
    private final Class<?>[] grpcClasses = {com.google.protobuf.Any.class,
    ...
    public void registerHints(RuntimeHints hints, ClassLoader classLoader) {
        Stream.of(javaClasses, hessianClasses, sqlClasses, grpcClasses, jraftDataClasses,
                jraftRpcClasses,
                jraftCliClasses, jraftUtilClasses, nacosClasses).flatMap(Stream::of)
