...
import com.alibaba.nacos.springdoc.openapi.NacosSchemaOpenApiCustomizer;
...
public class DocConfig {
    ...
    @Bean
    public GlobalOpenApiCustomizer nacosConsoleOpenApiCustomizer(PropertyResolverUtils propertyResolverUtils) {
        return new NacosBasicInfoOpenApiCustomizer("nacos.console.api.title", "nacos.console.api.description",
                propertyResolverUtils);
    }
    
    @Bean
    public GlobalOpenApiCustomizer genericSchemaOpenApiCustomizer(SchemaCache consoleSchemaCache) {
        return new NacosSchemaOpenApiCustomizer(consoleSchemaCache);
    }
    
    @Bean
    public GlobalOpenApiCustomizer nacosAuthSecurityRequirementOpenApiCustomizer(
    ...
    @Bean
    public GlobalOperationCustomizer genericSchemaOperationCustomize(SchemaCache consoleSchemaCache) {
        return new NacosGenericSchemaOperationCustomize(consoleSchemaCache);
    }
    
    @Bean
    public GlobalOperationCustomizer requestBodyHiddenOperationCustomize() {
        return new NacosRequestBodyHiddenOperationCustomizer();
    }
    
    @Bean
    public GlobalOperationCustomizer exampleI18nOperationCustomize(PropertyResolverUtils propertyResolverUtils) {
