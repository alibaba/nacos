...
public class NacosRemoteHandlerConfiguration {
    ...
    @Value("${nacos.server.list:127.0.0.1:8848}")
    private String serverList;
    
    @Bean
    public ConfigMaintainerService getConfigMaintainerService() throws NacosException {
        return NacosMaintainerFactory.createConfigMaintainerService(serverList);
    }
}