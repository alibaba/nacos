...
public class NamespaceController {
    ...
    @Autowired private NamespacePersistService namespacePersistService;

    @Autowired private NamespaceOperationService namespaceOperationService;
    ...
    public Namespace getNamespace(@RequestParam("namespaceId") String namespaceId)
    ...
    public Boolean createNamespace(
        ...
        try {
            return namespaceOperationService.createNamespace(
