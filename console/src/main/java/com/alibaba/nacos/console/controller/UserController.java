...
public class UserController {
    ...
    public Object login(@RequestParam String username, @RequestParam String password, HttpServletResponse response,
        ...
        // Authentication object is generated by username and password, the implementation class is UsernamePasswordAuthenticationToken.
        UsernamePasswordAuthenticationToken authenticationToken = new UsernamePasswordAuthenticationToken(username,
                password);
        
        RestResult<String> rr = new RestResult<String>();
        try {
            // Through AuthenticationManager(default implementation: ProviderManager)#authenticate method verify Authentication object.
