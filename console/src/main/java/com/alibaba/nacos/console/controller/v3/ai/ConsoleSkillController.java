...
public class ConsoleSkillController {
    ...
    public Result<SkillSubscriptionDocument> listSubscriptions(
        ...
        return Result.success(skillProxy.listSubscriptions(namespaceId));
    }
    ...
    public Result<SkillSubscriptionDocument> subscribe(
        ...
        throws NacosException {
        return Result.success(skillProxy.subscribe(namespaceId, subscriptions));
    }
    ...
    public Result<SkillSubscriptionDocument> unsubscribe(
        ...
        return Result.success(skillProxy.unsubscribe(namespaceId, nameList));
    }
