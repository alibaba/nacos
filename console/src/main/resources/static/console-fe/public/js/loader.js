    ...
    return (
      (t.validateConfigurationOptions = function(t, r) {
        return (
          ...
          ('object' == typeof r.ignoreDuplicateModules &&
            ...
            (n = e.Utilities.fileUriToFilePath(this._env.isWindows, n)),
              this._fs.readFile(n, { encoding: 'utf8' }, function(e, d) {
                if (e) i(e);
                  ...
                  if (
                    ((p =
                      d.charCodeAt(0) === t._BOM ? g + d.substring(1) + '\n});' : g + d + '\n});'),
                    (p = l(p, c)),
                    a.nodeCachedDataDir)
                  ) {
...
!(function(e) {
  ...
  function r() {
    ...
    if (
      ((n = new e.ModuleManager(r, s, o, i, e.Utilities.getHighPerformanceTimestamp())), r.isNode)
    ) {
