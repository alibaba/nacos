...
!(function(e) {
  ...
  (function(e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      'function' == typeof define &&
        define.amd &&
        define('vscode-nls/vscode-nls', ['require', 'exports'], e);
  })(function(e, t) {
    function n(e, t) {
      var n;
      return (n =
    ...
    (t.CSSIssueType = i),
      (t.ParseError = {
        ...
        ConditionExpected: new i(
          ...
          r('expected.condt', 'condition expected')
        ),
        ...
        VariableNameExpected: new i(
          'css-varnameexpected',
          r('expected.varname', 'variable name expected')
        ),
        VariableValueExpected: new i(
          'css-varvalueexpected',
          r('expected.varvalue', 'variable value expected')
        ),
        ...
        LeftSquareBracketExpected: new i(
          ...
          r('expected.lsquare', '[ expected')
        ),
        RightSquareBracketExpected: new i(
          'css-lbracketexpected',
          r('expected.rsquare', '] expected')
        ),
        ...
        SelectorExpected: new i(
          ...
          r('expected.selector', 'selector expected')
        ),
      ...
      css: {
        ...
        properties: [
          ...
          },
          {
            ...
            values: [
              { name: 'normal', desc: 'User agent specific and typically equivalent to 1em.' },
            ],
          },
          {
            name: 'column-rule',
          ...
          },
          {
            ...
            values: [
              { name: 'none', desc: 'This element does not alter the value of any counters.' },
            ],
          },
          {
            name: 'counter-reset',
          ...
          },
          {
            ...
            restriction: 'string',
            values: [
              { name: 'none', desc: 'The grid container doesn’t define any named grid areas.' },
            ],
          },
          {
          ...
          },
          {
            ...
            values: [
              { name: 'attr(x)' },
              { name: 'none', desc: "No spanning. The computed value is '1'." },
            ],
          },
          {
          ...
          },
          {
            ...
            restriction: 'length, percentage',
            values: [
              { name: 'normal', desc: 'No additional spacing is applied. Computes to zero.' },
            ],
          },
          {
            name: 'word-wrap',
      ...
      w = (function() {
        ...
        return (
          ...
          Object.defineProperty(e.prototype, 'browsers', {
            get: function() {
              return (
                this.browserEntry || (this.browserEntry = c(this.data.browsers)), this.browserEntry
              );
            },
            enumerable: !0,
            configurable: !0,
        ...
        return (
          (e.prototype.peek = function(e, t, n) {
            return (
              ...
              e !== this.token.type
                ...
                : 'undefined' != typeof t
                ? n
                  ? t.toLowerCase() === this.token.text.toLowerCase()
                  : t === this.token.text
                : !0
            );
          }),
          ...
          (e.prototype.markError = function(e, t, n, i) {
            this.token !== this.lastErrorToken &&
              (e.addIssue(
                new r.Marker(e, t, r.Level.Error, null, this.token.offset, this.token.len)
              ),
          ...
          (e.prototype._parseRuleset = function(e) {
            ...
            for (
              ;
              this.accept(n.TokenType.Comma) && t.getSelectors().addChild(this._parseSelector(e));
          ...
          (e.prototype._parsePrio = function() {
            ...
            return this.accept(n.TokenType.Exclamation) &&
              this.accept(n.TokenType.Ident, 'important', !0)
              ? this.finish(e)
              : null;
          }),
          ...
          (e.prototype._parseFunctionIdentifier = function() {
            ...
            if (
              ...
              this.accept(n.TokenType.Ident, 'progid'))
            ) {
              if (this.accept(n.TokenType.Colon))
  ...
  (function(e) {
    ...
    !(function(e) {
      function t(e, t, n, r, i) {
        ...
        return (
          D.defined(n) && (o.severity = n),
          D.defined(r) && (o.code = r),
          D.defined(i) && (o.source = i),
          o
        );
      }
      function n(e) {
    ...
    !(function(e) {
      function t(e, t) {
        ...
        var i = { label: e };
        return (
          D.defined(t) && (i.documentation = t),
          D.defined(n) ? (i.parameters = n) : (i.parameters = []),
          i
        );
      }
      e.create = t;
      ...
      p = (function() {
        ...
        return (
              ...
              for (var a = this.nodePath.length - 1; a >= 0; a--) {
                ...
                if (s instanceof i.Property)
                  ...
                  s instanceof i.FunctionArgument
                    ...
                    : s instanceof i.Function && this.getCompletionsForFunctionArgument(null, s, o);
          ...
          (e.prototype.getVariableProposalsForCSSVarFunction = function(e) {
            var t = this,
              n = this.getSymbolContext().findSymbolsAtOffset(
                this.offset,
                i.ReferenceType.Variable
              );
            return (
          ...
          (e.prototype.getCompletionsForRuleSet = function(e, t) {
            ...
            return (
              e.findParent(i.NodeType.Ruleset),
      ...
      g = (function() {
        ...
        return (
          (e.prototype.visitNode = function(e) {
            return (
              (e instanceof i.HexColorValue ||
                (e instanceof i.Function && a.isColorConstructor(e))) &&
                this.entries.add(e.getText()),
              !0
            );
          }),
        ...
        e.getChildren().forEach(function(e) {
          if (e instanceof s.SimpleSelector) {
            if (t.prev instanceof s.SimpleSelector) {
              ...
              t.prev &&
                (t.prev.matches('+') || t.prev.matches('~')) &&
                (t.element = t.element.parent);
            t.prev &&
              t.prev.matches('~') &&
              (t.element.addChild(n(e)), t.element.addChild(new d('⋮')));
            var o = n(e, r),
              a = o.findRoot();
          ...
          (e.prototype.doHover = function(e, t, a) {
            ...
            for (var l = e.offsetAt(t), c = n.getNodePath(a, l), d = 0; d < c.length; d++) {
              ...
              if (h instanceof n.Selector)
                return { contents: o.selectorToMarkedString(h), range: s(h) };
      ...
      d = (function() {
        ...
        return (
          (e.prototype.findDefinition = function(e, t, r) {
            ...
            return d
              ? { uri: e.uri, range: n(d.node, e) }
              : { uri: e.uri, range: o.Range.create(t, t) };
          }),
              ...
              t.accept(function(t) {
                ...
                return (
                  t instanceof i.Selector
                    ...
                    : t instanceof i.FontFace && (a.name = c('literal.fontface', '@font-face')),
  ...
  (function(e) {
    ...
    (t.Rule = d),
      (t.Rules = {
        ...
        UnknownProperty: new d(
          'unknownProperties',
          a('rule.unknownProperty', 'Unknown property.'),
          s
        ),
        IEStarHack: new d(
          'ieHack',
        ...
        return (
          ...
          (e.prototype.getFixesForUnknownProperty = function(e, t, n, o) {
            ...
            for (var p = 3, m = 0, u = c; m < u.length; m++) {
              ...
              if (
                (o.push(a.Command.create(b, '_css.applyCodeAction', e.uri, e.version, [y])),
                --p <= 0)
              )
                return;
            }
                ...
                if (o.isCSSDeclaration(e)) {
                  ...
                  if ('-' === a) {
                    ...
                    ('*' !== a && '_' !== a) ||
                      ...
                      n.isKnownProperty(i) || o.addEntry(t.getProperty(), r.Rules.UnknownProperty),
                      O.add(i, i, null);
                } else R = !0;
              }),
              !R)
    ...
    (t.SCSSIssueType = i),
      (t.SCSSParseError = {
        ...
        ThroughOrToExpected: new i(
          ...
          r('expected.through', "'through' or 'to' expected")
        ),
      ...
      return (
        ...
        (t.prototype._parseVariableDeclaration = function(e) {
          ...
          if (!this.accept(r.TokenType.Colon, ':'))
            return this.finish(t, s.ParseError.ColonExpected);
        ...
        (t.prototype._parseIdent = function(e) {
          ...
          for (
            ...
            ((n = !0),
            !this.hasWhitespace() && this.accept(r.TokenType.Delim, '-'),
            !this.hasWhitespace());
        ...
        (t.prototype._parseExtends = function() {
          ...
          return this.accept(r.TokenType.AtKeyword, '@extend')
            ? e.setSelector(this._parseSimpleSelector())
              ? this.accept(r.TokenType.Exclamation) &&
                !this.accept(r.TokenType.Ident, 'optional', !0)
        ...
        (t.prototype._parseSelectorPlaceholder = function() {
          ...
          return this.accept(r.TokenType.Delim, '%')
            ...
            : this.accept(r.TokenType.AtKeyword, '@at-root')
            ? this.finish(e)
            : null;
        }),
            ...
            t.setVariable(this._parseVariable())
              ? this.accept(r.TokenType.Ident, 'from')
                ? t.addChild(this._parseBinaryExpr())
                  ? this.accept(r.TokenType.Ident, 'to') ||
                    this.accept(r.TokenType.Ident, 'through')
                    ? t.addChild(this._parseBinaryExpr())
                      ? this._parseBody(t, e)
        ...
        (t.prototype._parseFunctionArgument = function() {
          ...
          return e.setValue(this._parseExpr(!0))
            ? (e.addChild(this._parsePrio()), this.finish(e))
            : null;
        }),
  ...
  var n = e('./lessScanner'),
    ...
    s = (function(e) {
      ...
      return (
        ...
        (t.prototype._parseVariable = function() {
          for (
            var e = this.create(o.Variable), t = this.mark();
            this.accept(r.TokenType.Delim, '@');
        ...
        (t.prototype._parseEscaped = function() {
          ...
          return this.accept(r.TokenType.EscapedJavaScript) ||
            this.accept(r.TokenType.BadEscapedJavaScript)
            ? this.finish(e)
            : this.accept(r.TokenType.Delim, '~')
        ...
        (t.prototype._parseFunctionIdentifier = function() {
          if (this.peek(r.TokenType.Delim, '%')) {
            var t = this.create(o.Identifier);
            return (
              (t.referenceTypes = [o.ReferenceType.Function]), this.consumeToken(), this.finish(t)
            );
          }
