...
class NamespaceInnerHandlerTest {
    ...
    void createNamespace() throws NacosException {
        when(namespaceOperationService.createNamespace(NAMESPACE_ID, NAMESPACE_NAME,
                NAMESPACE_DESC)).thenReturn(true);
        assertTrue(namespaceInnerHandler.createNamespace(NAMESPACE_ID, NAMESPACE_NAME,
                NAMESPACE_DESC));
    }
