...
public class DistroModuleStateBuilder implements ModuleStateBuilder {
    ...
    public ModuleState build() {
        ...
        moduleState.newState(
                DistroConstants.DATA_SYNC_DELAY_MILLISECONDS_STATE,
                EnvUtil.getProperty(
                        DistroConstants.DATA_SYNC_DELAY_MILLISECONDS,
                        Long.class,
                        DistroConstants.DEFAULT_DATA_SYNC_DELAY_MILLISECONDS));
        moduleState.newState(
                DistroConstants.DATA_SYNC_TIMEOUT_MILLISECONDS_STATE,
                EnvUtil.getProperty(
        ...
        moduleState.newState(
                DistroConstants.DATA_LOAD_TIMEOUT_MILLISECONDS_STATE,
                EnvUtil.getProperty(
