...
public class RaftModuleStateBuilder implements ModuleStateBuilder {
    ...
    public ModuleState build() {
        ...
        moduleState.newState(
                RaftSysConstants.RAFT_CORE_THREAD_NUM,
