 ...
 *
 * <p><strong>WorkerId</strong> generation policy: Calculate the InetAddress hashcode
 *
 * <p>The repeat rate of the dataCenterId, the value of the maximum dataCenterId times the time of
 * each Raft election. The time for raft to select the master is generally measured in seconds. If
 * the interval of an election is 5 seconds, it will take 150 seconds for the DataCenterId to be
 * repeated. This is still based on the situation that the new master needs to be selected after
 * each election of the Leader
 *
