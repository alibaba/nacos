...
public final class RaftExecutor {
    ...
    public static void scheduleRaftMemberRefreshJob(
    ...
    public static void scheduleAtFixedRateByCommon(
            Runnable command, long initialDelayMs, long periodMs) {
        raftCommonExecutor.scheduleAtFixedRate(
                command, initialDelayMs, periodMs, TimeUnit.MILLISECONDS);
    }
