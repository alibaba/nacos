    ...
    private void ejectOutdatedConnection() {
        try {
            ...
            Loggers.CONNECTION.info(
                    ...
                    (totalCount - currentSdkClientCount));
            ...
            if (CollectionUtils.isNotEmpty(outDatedConnections)) {
                ...
                for (String outDateConnectionId : outDatedConnections) {
                    try {
                        ...
                        if (connection != null) {
                            ...
                            Loggers.CONNECTION.info(
                                    "[{}]send connection active request ", outDateConnectionId);
                        } else {
                            latch.countDown();
                        }
                ...
                Loggers.CONNECTION.info(
                        "Out dated connection check successCount={}", successConnections.size());

                for (String outDateConnectionId : outDatedConnections) {
                    if (!successConnections.contains(outDateConnectionId)) {
                        Loggers.CONNECTION.info(
                                "[{}]Unregister Out dated connection....", outDateConnectionId);
