...
public class ServerMemberManagerTest {
    ...
    @Mock private WebServerInitializedEvent mockEvent;
    ...
    public void setUp() throws Exception {
        ...
        serverMemberManager.updateMember(
                Member.builder().ip("1.1.1.1").port(8848).state(NodeState.UP).build());
        serverMemberManager.getMemberAddressInfos().add("1.1.1.1:8848");
        NotifyCenter.getPublisherMap()
                .put(MembersChangeEvent.class.getCanonicalName(), eventPublisher);
    }
    ...
    public void testHttpReportTaskWithoutMemberInfo() throws NacosException {
        Member testMember =
                Member.builder()
                        ...
                        .extendInfo(
                                Collections.singletonMap(MemberMetaDataConstants.VERSION, "test"))
                        .build();
        ...
        ReflectionTestUtils.setField(
                serverMemberManager, "asyncRestTemplate", mockAsyncRestTemplate);
        doAnswer(
                        invocationOnMock -> {
                ...
                .when(mockAsyncRestTemplate)
                .post(anyString(), any(), any(), any(), any(), any());
    ...
    public void testGrpcReportTaskWithoutMemberInfo() throws NacosException {
        ...
        ReflectionTestUtils.setField(
                infoReportTask, "clusterRpcClientProxy", clusterRpcClientProxy);
    ...
    public void testHttpReportTaskWithMemberInfoChanged() {
        ...
        Member newMember =
                Member.builder()
                        ...
                        .state(NodeState.DOWN)
                        .extendInfo(
                                Collections.singletonMap(MemberMetaDataConstants.VERSION, "new"))
                        .build();
        NacosAsyncRestTemplate mockAsyncRestTemplate = mock(NacosAsyncRestTemplate.class);
        ReflectionTestUtils.setField(
                serverMemberManager, "asyncRestTemplate", mockAsyncRestTemplate);
        doAnswer(
                        invocationOnMock -> {
                            ...
                            RestResult<String> result =
                                    RestResultUtils.success(JacksonUtils.toJson(newMember));
                            callback.onReceive(result);
                            return null;
                        })
                .when(mockAsyncRestTemplate)
