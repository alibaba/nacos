...
public class ModuleStateClusterTest {
    ...
    public void testStandaloneBuilder() {
        assertTrue(ModuleStateHolder.getInstance().getModuleState(DistroConstants.DISTRO_MODULE).isPresent());
        assertTrue(ModuleStateHolder.getInstance().getModuleState(RaftSysConstants.RAFT_STATE).isPresent());
    }
}
