...
public class RaftModuleStateBuilderTest {
    ...
    public void testBuild() {
        ...
        assertEquals(
                RaftSysConstants.DEFAULT_MAX_BODY_SIZE, states.get(RaftSysConstants.MAX_BODY_SIZE));
        assertEquals(
        ...
        assertEquals(
                RaftSysConstants.DEFAULT_APPLY_BATCH, states.get(RaftSysConstants.APPLY_BATCH));
