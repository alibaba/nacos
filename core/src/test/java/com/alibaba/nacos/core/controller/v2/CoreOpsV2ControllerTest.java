...
public class CoreOpsV2ControllerTest {
    ...
    @InjectMocks private CoreOpsV2Controller coreOpsV2Controller;

    @Mock private ProtocolManager protocolManager;

    @Mock private IdGeneratorManager idGeneratorManager;
