...
public class JRaftProtocolTest extends TestCase {
    ...
    @Mock private JRaftServer serverMock;

    private JRaftProtocol raftProtocol;

    @Mock private JRaftMaintainService jRaftMaintainService;
    ...
    @Mock private CompletableFuture<Response> futureMock;

    @Mock private Node nodeMock;
    ...
    public void testWrite() throws Exception {
        ...
        verify(serverMock)
                .commit(any(String.class), eq(writeRequest), any(CompletableFuture.class));
    }
