...
public class JRaftServerTest {
    ...
    @Mock private RequestProcessor4CP mockProcessor4CP;
    ...
    @Mock private CliClientServiceImpl cliClientServiceMock;

    @Mock private CliService cliServiceMock;

    @Mock private RpcClient rpcClient;

    @Mock private CompletableFuture<Response> future;
    ...
    @Mock private RaftGroupService raftGroupService;

    @Mock private NacosStateMachine nacosStateMachine;
    ...
    public void before() throws NoSuchFieldException, IllegalAccessException {
        ...
        map.put(
                ...
                new JRaftServer.RaftGroupTuple(
                        node, requestProcessor, raftGroupService, nacosStateMachine));
    ...
    public void testInvokeToLeader()
        ...
        Method invokeToLeaderMethod =
                JRaftServer.class.getDeclaredMethod(
                        "invokeToLeader",
                        String.class,
                        Message.class,
                        int.class,
    ...
    public void testCommit()
            throws NoSuchFieldException, IllegalAccessException, TimeoutException,
    ...
    public void testPeerChange() {
        ...
        JRaftMaintainService service =
                new JRaftMaintainService(server) {
                    @Override
        ...
        Collection<Member> firstEvent =
                Arrays.asList(
                        Member.builder().ip("1.1.1.1").port(7848).build(),
