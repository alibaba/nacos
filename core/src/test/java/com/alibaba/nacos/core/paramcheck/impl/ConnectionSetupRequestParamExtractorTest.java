...
public class ConnectionSetupRequestParamExtractorTest {
    
    private static ConnectionSetupRequest req;
    
    @BeforeClass
    public static void initConnectionSetupRequest() {
        req = new ConnectionSetupRequest();
    }
    ...
    public void testExtractParamAndCheck() throws Exception {
        ...
        assertEquals(extractor.getClass().getSimpleName(), ConnectionSetupRequestParamExtractor.class.getSimpleName());
