...
/**
 * {@link ServiceListRequestParamExtractor} unit test.
 */
class ServiceListRequestParamExtractorTest {
    
    private ServiceListRequestParamExtractor extractor;
    
    @BeforeEach
    void setUp() {
        extractor = new ServiceListRequestParamExtractor();
    }
