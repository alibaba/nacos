...
public class ConnectionManagerTest {
    ...
    @InjectMocks private ConnectionManager connectionManager;

    @Mock private ClientConnectionEventListenerRegistry clientConnectionEventListenerRegistry;

    @InjectMocks private GrpcConnection connection;

    @Mock private Channel channel;

    @Mock private ConnectionMeta connectionMeta;
