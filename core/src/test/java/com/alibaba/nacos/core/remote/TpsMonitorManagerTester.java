...
public class TpsMonitorManagerTester {
    ...
    private static final int MAX_COUNT1 = 5000;
    
    private static final int MAX_COUNT2 = 2000000;
    ...
    static {
        ...
        rule.setPointRule(new TpsControlRule.Rule(MAX_COUNT1, TimeUnit.SECONDS, "SUM", "intercept"));
        rule.getMonitorKeyRule()
                .putIfAbsent("testKey:a*b", new TpsControlRule.Rule(MAX_COUNT1, TimeUnit.MINUTES, "EACH", "intercept"));
        rule.getMonitorKeyRule()
                .putIfAbsent("testKey:*", new TpsControlRule.Rule(MAX_COUNT2, TimeUnit.MINUTES, "SUM", "intercept"));
