...
public class GrpcRequestAcceptorTest {
    ...
    @Mock private RequestHandlerRegistry requestHandlerRegistry;

    @InjectMocks private GrpcRequestAcceptor acceptor;
        ...
        StreamObserver<Payload> streamObserver =
                new StreamObserver<Payload>() {
                    ...
                    public void onNext(Payload payload) {
                        ...
                        Assert.assertEquals(
                                errorResponse.getErrorCode(), NacosException.INVALID_SERVER_STATUS);
                    }
        ...
        StreamObserver<Payload> streamObserver =
                new StreamObserver<Payload>() {
                    ...
                    public void onNext(Payload payload) {
                        ...
                        ErrorResponse errorResponse = (ErrorResponse) res;
                        Assert.assertEquals(
                                errorResponse.getErrorCode(), NacosException.NO_HANDLER);
                    }
        ...
        StreamObserver<Payload> streamObserver =
                new StreamObserver<Payload>() {
                    ...
                    public void onNext(Payload payload) {
                        ...
                        ErrorResponse errorResponse = (ErrorResponse) res;
                        Assert.assertEquals(
                                errorResponse.getErrorCode(), NacosException.UN_REGISTER);
                    }
        ...
        StreamObserver<Payload> streamObserver =
                new StreamObserver<Payload>() {
                    ...
                    public void onNext(Payload payload) {
                        ...
                        ErrorResponse errorResponse = (ErrorResponse) res;
                        Assert.assertEquals(
                                errorResponse.getErrorCode(), NacosException.BAD_GATEWAY);
                    }
        ...
        StreamObserver<Payload> streamObserver =
                new StreamObserver<Payload>() {
                    ...
                    public void onNext(Payload payload) {
                        ...
                        ErrorResponse errorResponse = (ErrorResponse) res;
                        Assert.assertEquals(
                                errorResponse.getErrorCode(), NacosException.SERVER_ERROR);
                    }
