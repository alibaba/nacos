...
| `ai/.../a2a/migration/A2aMigrationQuiescingTask.java` | Installs local ACKs, enforces timeout/member rollback, and runs the final cutover gates. | Delete the scheduler and quiescing-timeout property. | Canonical Agent/RAD services. | Remove quiescing tests; retain canonical restart tests. |
