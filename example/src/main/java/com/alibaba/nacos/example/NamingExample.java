...
public class NamingExample {
    ...
    public static void main(String[] args) throws NacosException, InterruptedException {
        ...
        naming.registerInstance(INSTANCE_SERVICE_NAME, INSTANCE_IP, INSTANCE_PORT,
        ...
        naming.subscribe(INSTANCE_SERVICE_NAME, new AbstractEventListener() {
            ...
            public void onEvent(Event event) {
                ...
                System.out
                    .println("[instances from event] " + ((NamingEvent) event).getInstances());
            }
        });
        ...
        System.out
            .println("[instances after register] " + naming.getAllInstances(INSTANCE_SERVICE_NAME));
        
        Thread.sleep(1000);
        
        naming.deregisterInstance(INSTANCE_SERVICE_NAME, INSTANCE_IP, INSTANCE_PORT,
            INSTANCE_CLUSTER_NAME);
        
        Thread.sleep(1000);
        
        System.out.println(
            "[instances after deregister] " + naming.getAllInstances(INSTANCE_SERVICE_NAME));
