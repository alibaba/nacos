...
public class NacosAiMaintainerServiceImpl implements AiMaintainerService {
    ...
    @Override
    public String createAgentSpecDraft(String namespaceId, String agentSpecName, String basedOnVersion)
            throws NacosException {
        if (StringUtils.isBlank(namespaceId)) {
            namespaceId = com.alibaba.nacos.api.common.Constants.DEFAULT_NAMESPACE_ID;
        }
    ...
    @Override
    public boolean updateAgentSpecDraft(String namespaceId, String agentSpecCard, Boolean setAsLatest)
            throws NacosException {
        if (StringUtils.isBlank(namespaceId)) {
            namespaceId = com.alibaba.nacos.api.common.Constants.DEFAULT_NAMESPACE_ID;
        }
    ...
    @Override
    public boolean deleteAgentSpecDraft(String namespaceId, String agentSpecName) throws NacosException {
        if (StringUtils.isBlank(namespaceId)) {
            namespaceId = com.alibaba.nacos.api.common.Constants.DEFAULT_NAMESPACE_ID;
        }
        Map<String, String> params = new HashMap<>(4);
    ...
    @Override
    public String submitAgentSpec(String namespaceId, String agentSpecName, String version) throws NacosException {
        if (StringUtils.isBlank(namespaceId)) {
            namespaceId = com.alibaba.nacos.api.common.Constants.DEFAULT_NAMESPACE_ID;
        }
        Map<String, String> params = new HashMap<>(8);
    ...
    @Override
    public boolean publishAgentSpec(String namespaceId, String agentSpecName, String version,
    ...
    @Override
    public boolean updateAgentSpecLabels(String namespaceId, String agentSpecName, String labels)
            throws NacosException {
        if (StringUtils.isBlank(namespaceId)) {
            namespaceId = com.alibaba.nacos.api.common.Constants.DEFAULT_NAMESPACE_ID;
        }
    ...
    @Override
    public boolean changeAgentSpecOnlineStatus(String namespaceId, String agentSpecName, String scope, String version,
