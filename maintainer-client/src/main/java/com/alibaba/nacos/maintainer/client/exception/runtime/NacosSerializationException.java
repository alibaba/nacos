...
public class NacosSerializationException extends NacosRuntimeException {
    ...
    public NacosSerializationException() {
        super(Constant.Exception.SERIALIZE_ERROR_CODE);
    }
    
    public NacosSerializationException(Class<?> serializedClass) {
        super(Constant.Exception.SERIALIZE_ERROR_CODE, String.format(MSG_FOR_SPECIFIED_CLASS, serializedClass.getName()));
        this.serializedClass = serializedClass;
    }
    
    public NacosSerializationException(Throwable throwable) {
        super(Constant.Exception.SERIALIZE_ERROR_CODE, DEFAULT_MSG, throwable);
    }
    
    public NacosSerializationException(Class<?> serializedClass, Throwable throwable) {
        super(Constant.Exception.SERIALIZE_ERROR_CODE, String.format(MSG_FOR_SPECIFIED_CLASS, serializedClass.getName()), throwable);
        this.serializedClass = serializedClass;
    }
