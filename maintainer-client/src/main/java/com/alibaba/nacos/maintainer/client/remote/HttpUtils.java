...
import com.alibaba.nacos.maintainer.client.utils.UuidUtils;
import com.alibaba.nacos.maintainer.client.utils.VersionUtils;
...
import static com.alibaba.nacos.maintainer.client.constants.RequestUrlConstants.HTTP_PREFIX;
...
public final class HttpUtils {
    ...
    public static void initRequestEntity(ClassicHttpRequest requestBase, Object body, Header header) throws Exception {
        ...
        if (requestBase instanceof HttpEntityContainer) {
            ...
            MediaType mediaType = MediaType.valueOf(header.getValue(HttpConstants.CONTENT_TYPE));
    ...
    public static Header builderHeader(String module) {
        ...
        header.addParam(HttpConstants.CLIENT_VERSION_HEADER, VersionUtils.version);
        header.addParam(HttpConstants.USER_AGENT_HEADER, VersionUtils.getFullClientVersion());
        header.addParam(HttpConstants.ACCEPT_ENCODING, "gzip,deflate,sdch");
        header.addParam(HttpConstants.CONNECTION, "Keep-Alive");
        header.addParam(HttpConstants.REQUEST_ID, UuidUtils.generateUuid());
        header.addParam(HttpConstants.REQUEST_MODULE, module);
        return header;
    }
