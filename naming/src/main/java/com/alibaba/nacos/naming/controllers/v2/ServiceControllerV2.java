...
@RequestMapping(
        UtilsAndCommons.DEFAULT_NACOS_NAMING_CONTEXT_V2
                + UtilsAndCommons.NACOS_NAMING_SERVICE_CONTEXT)
public class ServiceControllerV2 {
    ...
    public ServiceControllerV2(
            ServiceOperatorV2Impl serviceOperatorV2, SelectorManager selectorManager) {
    ...
    public Result<String> remove(
        ...
        NotifyCenter.publishEvent(
                new DeregisterServiceTraceEvent(
                        System.currentTimeMillis(), namespaceId, groupName, serviceName));
        return Result.success("ok");
    }
    ...
    public Result<ServiceDetailInfo> detail(
            ...
            @RequestParam(value = "groupName", defaultValue = Constants.DEFAULT_GROUP)
                    String groupName)
            throws Exception {
        ServiceDetailInfo result =
                serviceOperatorV2.queryService(
    ...
    public Result<ServiceNameView> list(
            ...
            @RequestParam(
                    ...
                    String groupName,
            @RequestParam(value = "selector", required = false, defaultValue = StringUtils.EMPTY)
                    String selector,
        ...
        Collection<String> serviceNameList =
                serviceOperatorV2.listService(namespaceId, groupName, selector);
