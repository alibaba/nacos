...
public interface InstanceOperator {
     ...
     */
    void registerInstance(String namespaceId, String serviceName, Instance instance)
     ...
     */
    void removeInstance(String namespaceId, String serviceName, Instance instance)
            throws NacosException;

    /**
     * Update instance information. Due to the basic information can't be changed, so this update
     * should only update metadata.
     *
     ...
     */
    void updateInstance(String namespaceId, String serviceName, Instance instance)
            throws NacosException;

    /**
     * Patch update instance information. Due to the basic information can't be changed, so this
     * update should only update metadata.
     *
     ...
     * @throws NacosException nacos exception when update failed
     */
    void patchInstance(String namespaceId, String serviceName, InstancePatchObject patchObject)
            throws NacosException;
    ...
    Instance getInstance(
            String namespaceId, String serviceName, String cluster, String ip, int port)
            throws NacosException;
     ...
     * @param builder client beat instance builder, will be used when current instance is not exist
     *     and clientBeat exist
     * @return result code
    ...
    long getHeartBeatInterval(
            String namespaceId, String serviceName, String ip, int port, String cluster);
     ...
     */
    List<String> batchUpdateMetadata(
            String namespaceId,
     ...
     * @throws NacosException nacos exception during update
     */
    List<String> batchDeleteMetadata(
            String namespaceId,
            InstanceOperationInfo instanceOperationInfo,
            Map<String, String> metadata)
            throws NacosException;
