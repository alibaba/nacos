...
import com.alibaba.nacos.naming.consistency.persistent.impl.PersistentServiceOperateAdaptor;
...
/**
 * // TODO The old data is converted to the new data model
 * Nacos service discovery module V1 version of the operation.
 *
 * @author <a href="mailto:liaochuntao@live.com">liaochuntao</a>
 */
public class PersistentServiceV1Operator extends PersistentServiceOperateAdaptor
    ...
    private final BasePersistentServiceProcessor processor;
    
    public PersistentServiceV1Operator(BasePersistentServiceProcessor processor) {
    ...
    @Override
    protected boolean handleApply(Op op, BatchWriteRequest request) {
        publishValueChangeEvent(op, request);
        return true;
    }
    
    @Override
    protected boolean interested(Map<String, String> extendInfo) {
        return MapUtil.isEmpty(extendInfo);
    }
