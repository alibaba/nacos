 ...
 *
 * <p>When an original object like service or instance be remove, the metadata need to be removed.
 *
 * @author xiweng.yy
 */
public class ExpiredMetadataInfo {
    ...
    public static ExpiredMetadataInfo newExpiredInstanceMetadata(
            Service service, String metadataId) {
