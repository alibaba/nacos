...
public class HealthCheckProcessorV2Delegate implements HealthCheckProcessorV2 {
    ...
    private boolean isInvalidActiveCheckTarget(HealthCheckTaskV2 task, Service service, ClusterMetadata metadata,
        ...
        return !(metadata.getHealthChecker() instanceof Http)
                || !HealthCheckTargetUtil.isValidHttpHealthChecker((Http) metadata.getHealthChecker());
    }
