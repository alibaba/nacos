...
public class HttpClient {
     ...
     */
    public static RestResult<String> httpDelete(
     ...
     * @return {@link RestResult} as response
     */
    public static RestResult<String> httpGet(
            String url, List<String> headers, Map<String, String> paramValues) {
        return request(
                url,
                headers,
     ...
     * @return {@link RestResult} as response
     */
    public static RestResult<String> request(
            String url,
            List<String> headers,
        ...
        HttpClientConfig httpClientConfig =
                HttpClientConfig.builder()
                        .setConTimeOutMillis(connectTimeout)
        ...
        try {
            return APACHE_SYNC_NACOS_REST_TEMPLATE.exchange(
                    url, httpClientConfig, header, query, body, method, String.class);
        } catch (Exception e) {
    ...
    public static void asyncHttpPostLarge(
            String url, List<String> headers, String content, Callback<String> callback)
            throws Exception {
     ...
     */
    public static void asyncHttpPostLarge(
            String url, List<String> headers, byte[] content, Callback<String> callback)
            throws Exception {
        Header header = Header.newInstance();
        if (CollectionUtils.isNotEmpty(headers)) {
            header.addAll(headers);
    ...
    public static RestResult<String> httpPost(
            String url, List<String> headers, Map<String, String> paramValues) {
        ...
        try {
            ...
            HttpClientConfig httpClientConfig =
                    HttpClientConfig.builder()
                            ...
                            .build();
            return APACHE_SYNC_NACOS_REST_TEMPLATE.postForm(
                    url, httpClientConfig, header, paramValues, String.class);
        } catch (Throwable e) {
            return RestResult.<String>builder().withCode(500).withMsg(e.toString()).build();
        }
    }
    ...
    public static void asyncHttpPutLarge(
            String url, Map<String, String> headers, byte[] content, Callback<String> callback)
            throws Exception {
        Header header = Header.newInstance();
     ...
     * @return {@link RestResult} as response
     */
    public static RestResult<String> httpPutLarge(
            String url, Map<String, String> headers, byte[] content) {
        Header header = Header.newInstance();
        if (MapUtils.isNotEmpty(headers)) {
            header.addAll(headers);
        }
        AuthHeaderUtil.addIdentityToHeader(header);
        try {
            return APACHE_SYNC_NACOS_REST_TEMPLATE.put(
                    url, header, Query.EMPTY, content, String.class);
        } catch (Exception e) {
            return RestResult.<String>builder().withCode(500).withMsg(e.toString()).build();
        }
    }
     ...
     * @return {@link RestResult} as response
     */
    public static RestResult<String> httpGetLarge(
            String url, Map<String, String> headers, String content) {
        Header header = Header.newInstance();
        if (MapUtils.isNotEmpty(headers)) {
            header.addAll(headers);
        }
        AuthHeaderUtil.addIdentityToHeader(header);
        try {
            return APACHE_SYNC_NACOS_REST_TEMPLATE.getLarge(
                    url, header, Query.EMPTY, content, String.class);
        } catch (Exception e) {
            return RestResult.<String>builder().withCode(500).withMsg(e.toString()).build();
        }
     ...
     * @return {@link RestResult} as response
     */
    public static RestResult<String> httpPostLarge(
            String url, Map<String, String> headers, String content) {
        Header header = Header.newInstance();
        if (MapUtils.isNotEmpty(headers)) {
            header.addAll(headers);
