...
public class PushExecutorDelegate implements PushExecutor {
    ...
    public void doPush(Service service, String clientId, Subscriber subscriber, PushDataWrapper data) {
        getPushExecuteService(clientId, subscriber).doPush(service, clientId, subscriber, data);
    }
    ...
    public void doPushWithCallback(Service service, String clientId, Subscriber subscriber, PushDataWrapper data, PushCallBack callBack) {
        getPushExecuteService(clientId, subscriber).doPushWithCallback(service, clientId, subscriber, data, callBack);
    }
