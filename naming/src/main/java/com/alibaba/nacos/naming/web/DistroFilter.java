...
public class DistroFilter implements Filter {
    ...
    @Autowired private DistroTagGenerator distroTagGenerator;
    ...
    public void doFilter(
        ...
        try {
            ...
            RestResult<String> result =
                    HttpClient.request(
                            HTTP_PREFIX + targetServer + req.getRequestURI(),
                            headerList,
                            paramsValue,
                            body,
            ...
            try {
                ...
                Loggers.SRV_LOG.warn(
                        "[DISTRO-FILTER] request failed: "
                                + distroMapper.mapSrv(distroTag)
                                + urlString);
            }
