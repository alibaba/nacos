...
public class CheckSumTest {
    ...
    private String checkSumThreadNotSafeVersion(String checkString) {
        return new BigInteger(1, MESSAGE_DIGEST.digest((checkString).getBytes(StandardCharsets.UTF_8))).toString(16);
    }

    private void checkSumThreadSafeVersion(String checkString) {
        synchronized (MessageDigest.class) {
            new BigInteger(1, MESSAGE_DIGEST.digest((checkString).getBytes(StandardCharsets.UTF_8))).toString(16);
        }
    }
}
