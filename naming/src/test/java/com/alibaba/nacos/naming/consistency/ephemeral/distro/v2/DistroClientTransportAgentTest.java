...
public class DistroClientTransportAgentTest {
    ...
    @Mock ClusterRpcClientProxy clusterRpcClientProxy;

    @Mock ServerMemberManager memberManager;

    @Mock ConfigurableApplicationContext context;

    @Mock DistroCallback distroCallback;

    @InjectMocks DistroClientTransportAgent transportAgent;
    ...
    public void setUp() throws Exception {
        ...
        doAnswer(
                ...
                .when(clusterRpcClientProxy)
                .asyncRequest(eq(member), any(), any());
        // When run all project, the TpsNamingMonitor will be init by other unit test, will throw
