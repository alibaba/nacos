...
public class CatalogControllerV2Test extends BaseTest {
    ...
    @InjectMocks private CatalogControllerV2 catalogControllerV2;
    ...
    public void testInstanceList() throws Exception {
        ...
        when(catalogServiceV2.listAllInstances(
                        Constants.DEFAULT_NAMESPACE_ID, groupName, serviceNameWithoutGroup))
                .thenReturn(instances);
        MockHttpServletRequestBuilder builder =
                MockMvcRequestBuilders.get(
                                UtilsAndCommons.DEFAULT_NACOS_NAMING_CONTEXT_V2
                                        + UtilsAndCommons.NACOS_NAMING_CATALOG_CONTEXT
                                        + "/instances")
        ...
        JsonNode data =
                JacksonUtils.toObj(response.getContentAsString()).get("data").get("instances");
