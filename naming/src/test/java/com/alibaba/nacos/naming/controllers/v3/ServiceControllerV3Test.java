...
class ServiceControllerV3Test {
    ...
    void testRemove() throws Exception {
        ...
        verify(serviceOperatorV2).delete(
                Service.newService(Constants.DEFAULT_NAMESPACE_ID, Constants.DEFAULT_GROUP,
                        "service"));
        assertEquals("ok", actual.getData());
        assertEquals(ErrorCode.SUCCESS.getCode(), actual.getCode());
    }
    ...
    void testSubscribers() throws Exception {
        ...
        Mockito.when(serviceOperatorV2.getSubscribers("testNamespace", "testService", "testGroup",
                true, 1, 10))
