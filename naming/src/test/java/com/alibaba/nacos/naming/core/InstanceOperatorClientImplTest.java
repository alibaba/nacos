...
public class InstanceOperatorClientImplTest {
    ...
    @InjectMocks private InstanceOperatorClientImpl instanceOperatorClient;
    ...
    @Mock private NamingMetadataOperateService metadataOperateService;

    @Mock private NamingMetadataManager metadataManager;

    @Mock private SwitchDomain switchDomain;

    @Mock private UdpPushService pushService;
    ...
    public void testRegisterInstanceWithInvalidClusterName() throws NacosException {
        ...
        new InstanceOperatorClientImpl(null, null, null, null, null, null, null)
                .registerInstance("ns-01", "serviceName01", instance);
    }
    ...
    public void testUpdateInstance() throws NacosException {
        ...
        Mockito.verify(metadataOperateService)
                .updateInstanceMetadata(Mockito.any(), Mockito.any(), Mockito.any());
    }
    ...
    public void testPatchInstance() throws NacosException {
        ...
        instanceOperatorClient.patchInstance(
                "A", "B", new InstancePatchObject("C", "1.1.1.1", 8848));
    ...
    public void testHandleBeat() throws NacosException {
        ...
        int res =
                instanceOperatorClient.handleBeat(
                        "A",
                        "C",
                        "1.1.1.1",
                        8848,
    ...
    public void testBatchUpdateMetadata() throws NacosException {
        ...
        List<String> res =
                instanceOperatorClient.batchUpdateMetadata(
                        "A", instanceOperationInfo, new HashMap<>());
    ...
    public void testBatchDeleteMetadata() throws NacosException {
        ...
        List<String> res =
                instanceOperatorClient.batchDeleteMetadata(
                        "A", new InstanceOperationInfo(), new HashMap<>());
