...
public class ClientManagerDelegateTest {
    ...
    @Mock private ConnectionBasedClientManager connectionBasedClientManager;

    @Mock private EphemeralIpPortClientManager ephemeralIpPortClientManager;

    @Mock private PersistentIpPortClientManager persistentIpPortClientManager;
