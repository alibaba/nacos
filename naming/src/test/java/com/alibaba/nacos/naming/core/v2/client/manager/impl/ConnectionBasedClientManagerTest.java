...
public class ConnectionBasedClientManagerTest {
    ...
    @Mock private ConnectionBasedClient client;
    ...
    public void setUp() throws Exception {
        ...
        assertTrue(
                connectionBasedClientManager.verifyClient(
                        new DistroClientVerifyInfo(connectionId, 0)));
    ...
    public void testContainsConnectionId() {
        ...
        assertFalse(
                connectionBasedClientManager.verifyClient(
                        new DistroClientVerifyInfo(unUsedClientId, 0)));
