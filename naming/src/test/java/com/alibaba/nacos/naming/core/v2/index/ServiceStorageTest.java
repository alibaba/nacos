...
public class ServiceStorageTest {
    ...
    @Mock private ClientManagerDelegate clientManagerDelegate;

    @Mock private SwitchDomain switchDomain;

    @Mock private NamingMetadataManager namingMetadataManager;

    @Mock private ServiceInfo serviceInfo;

    @Mock private InstancePublishInfo instancePublishInfo;
    ...
    public void setUp() throws NoSuchFieldException, IllegalAccessException {
        ...
        ConcurrentMap<Service, Set<String>> serviceSetConcurrentMap =
                (ConcurrentMap<Service, Set<String>>) serviceClusterIndex.get(serviceStorage);
        ...
        ConcurrentMap<Service, ServiceInfo> infoConcurrentMap =
                (ConcurrentMap<Service, ServiceInfo>) serviceDataIndexes.get(serviceStorage);
    ...
    public void testGetInstanceInfo()
        ...
        Method getInstanceInfo =
                serviceStorageClass.getDeclaredMethod(
                        "getInstanceInfo", String.class, Service.class);
        getInstanceInfo.setAccessible(true);
        Optional<InstancePublishInfo> optionalInstancePublishInfo =
                (Optional<InstancePublishInfo>)
                        getInstanceInfo.invoke(serviceStorage, NACOS, SERVICE);
    ...
    public void testParseInstance()
        ...
        Mockito.verify(namingMetadataManager)
                .getInstanceMetadata(SERVICE, instancePublishInfo.getMetadataId());
