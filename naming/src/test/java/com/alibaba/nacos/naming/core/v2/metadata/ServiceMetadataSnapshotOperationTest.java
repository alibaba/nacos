...
public class ServiceMetadataSnapshotOperationTest {
    ...
    public void setUp() throws Exception {
        ...
        serviceMetadataSnapshotOperation =
                new ServiceMetadataSnapshotOperation(
    ...
    public void testGetSnapshotSaveTag() {
        ...
        Assert.assertEquals(
                snapshotSaveTag, ServiceMetadataSnapshotOperation.class.getSimpleName() + ".SAVE");
    }
    ...
    public void testGetSnapshotLoadTag() {
        ...
        Assert.assertEquals(
                snapshotLoadTag, ServiceMetadataSnapshotOperation.class.getSimpleName() + ".LOAD");
    }
}
