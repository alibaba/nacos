...
public class ClientOperationServiceProxyTest {
    @Mock private EphemeralClientOperationServiceImpl ephemeralClientOperationServiceImpl;

    @Mock private PersistentClientOperationServiceImpl persistentClientOperationServiceImpl;
    ...
    @Mock private Instance ephemeralInstance;

    @Mock private Instance persistentInstance;
    ...
    public void setUp() throws Exception {
        clientOperationServiceProxy =
                new ClientOperationServiceProxy(
    ...
    public void testChooseEphemeralClientOperationService() throws NacosException {
        ...
        verify(ephemeralClientOperationServiceImpl)
        ...
        clientOperationServiceProxy.deregisterInstance(
                service, ephemeralInstance, ephemeralIpPortId);
    ...
    public void testChoosePersistentClientOperationService() throws NacosException {
        clientOperationServiceProxy.registerInstance(
                service, persistentInstance, persistentIpPortId);
        verify(persistentClientOperationServiceImpl)
    ...
    public void testSubscribeService() {
        ...
        verify(ephemeralClientOperationServiceImpl)
                .subscribeService(service, subscriber, ephemeralIpPortId);
        verify(persistentClientOperationServiceImpl, never())
                .subscribeService(service, subscriber, ephemeralIpPortId);
    }
    ...
    public void testUnsubscribeService() {
        ...
        verify(ephemeralClientOperationServiceImpl)
                .unsubscribeService(service, subscriber, ephemeralIpPortId);
        verify(persistentClientOperationServiceImpl, never())
                .unsubscribeService(service, subscriber, ephemeralIpPortId);
    }
}
