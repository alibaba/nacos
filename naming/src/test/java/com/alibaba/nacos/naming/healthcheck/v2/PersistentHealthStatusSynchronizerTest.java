...
public class PersistentHealthStatusSynchronizerTest {
    ...
    @Mock private PersistentClientOperationServiceImpl persistentClientOperationService;
    ...
    public void testInstanceHealthStatusChange() {
        ...
        PersistentHealthStatusSynchronizer persistentHealthStatusSynchronizer =
                new PersistentHealthStatusSynchronizer(persistentClientOperationService);
        persistentHealthStatusSynchronizer.instanceHealthStatusChange(
                true, client, service, instancePublishInfo);
        ...
        verify(persistentClientOperationService)
                .updateInstance(service, updateInstance, client.getClientId());
    }
}
