...
public class HealthCheckProcessorV2DelegateTest {
    ...
    @Mock private HealthCheckExtendProvider healthCheckExtendProvider;

    @Mock private HealthCheckProcessorExtendV2 healthCheckProcessorExtendV2;
    ...
    public void setUp() {
        healthCheckProcessorV2Delegate =
                new HealthCheckProcessorV2Delegate(
