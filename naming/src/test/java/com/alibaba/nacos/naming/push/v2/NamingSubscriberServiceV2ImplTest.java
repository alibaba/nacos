...
public class NamingSubscriberServiceV2ImplTest {
    ...
    @Mock private ClientServiceIndexesManager indexesManager;

    @Mock private PushDelayTaskExecuteEngine delayTaskEngine;
    ...
    public void setUp() throws Exception {
        subscriberService =
                new NamingSubscriberServiceV2Impl(
                        clientManager, indexesManager, null, null, null, switchDomain);
        ...
        when(client.getSubscriber(service))
                .thenReturn(
                        new Subscriber(
                                "1.1.1.1:1111",
                                "Test",
                                ...
                                0));
        when(client.getSubscriber(service1))
                .thenReturn(
                        new Subscriber(
                                "1.1.1.1:1111",
                                "Test",
                                ...
                                "1.1.1.1",
                                "N",
                                service1.getGroupedServiceName(),
                                0));
    }
    ...
    public void testGetSubscribersByString() {
        Collection<Subscriber> actual =
                subscriberService.getSubscribers(
                        service.getNamespace(), service.getGroupedServiceName());
    ...
    public void testGetFuzzySubscribersByString() {
        Collection<Subscriber> actual =
                subscriberService.getFuzzySubscribers(
                        service.getNamespace(), service.getGroupedServiceName());
