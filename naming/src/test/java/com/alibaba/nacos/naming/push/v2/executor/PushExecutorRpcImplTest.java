...
public class PushExecutorRpcImplTest {
    ...
    @Mock private RpcPushService pushService;

    @Mock private Subscriber subscriber;

    @Mock private NamingPushCallback pushCallBack;
    ...
    public void setUp() throws Exception {
        ...
        EnvUtil.setEnvironment(new MockEnvironment());
        doAnswer(new CallbackAnswer())
                .when(pushService)
                .pushWithCallback(
                        eq(rpcClientId),
                        any(NotifySubscriberRequest.class),
                        eq(pushCallBack),
    ...
    private class CallbackAnswer implements Answer<Void> {
        ...
        public Void answer(InvocationOnMock invocationOnMock) throws Throwable {
            ...
            assertEquals(
                    pushData.getOriginalData().toString(), pushRequest.getServiceInfo().toString());
