...
public class DistroUtilsTest {
    ...
    private IpPortBasedClient buildClient(
            String ip,
            int port,
            boolean ephemeral,
            boolean healthy,
    ...
    private IpPortBasedClient buildClient(
        ...
        for (int i = 1; i < serviceCount + 1; i++) {
            client.putServiceInstance(
                    Service.newService(
                            DistroUtilsTest.NAMESPACE + i,
                            DistroUtilsTest.GROUP + i,
                            DistroUtilsTest.SERVICE + i,
                            ephemeral),
                    instance);
        }
        return client;
    ...
    public void performanceTestOfChecksum() {
        ...
        System.out.printf(
                "Distro Verify Checksum Performance: %.2f ivk/ns\n",
    ...
    public void performanceTestOfStringHash() {
        ...
        System.out.printf(
                "Distro Verify Revision Performance: %.2f ivk/ns\n",
                ((double) System.nanoTime() - start) / N);
    }
    ...
    public void performanceTestOfHash() {
        ...
        System.out.printf(
                "Distro Verify Hash Performance: %.2f ivk/ns\n",
                ((double) System.nanoTime() - start) / N);
    }
}
