...
public interface DatabaseOperate {
    ...
    /**
     * data importing, This method is suitable for importing data from external data sources into
    ...
    /**
     * data modify transaction The SqlContext to be executed in the current thread will be executed
    ...
    default CompletableFuture<Boolean> futureUpdate() {
        try {
            ...
            update(
                    EmbeddedStorageContextHolder.getCurrentSqlContext(),
                    (o, throwable) -> {
