...
class EmbeddedPaginationHelperImplTest {
    ...
    void testFetchPageWithoutResult() {
        when(databaseOperate.queryOne(QUERY_COUNT_SQL, new Object[] {}, Integer.class))
                .thenReturn(null);
        assertThrows(IllegalArgumentException.class,
                () -> embeddedPaginationHelper.fetchPage(QUERY_COUNT_SQL, QUERY_SQL,
                        new Object[] {}, 1, 1, null));
    }
    ...
    void testFetchPageOnePage() {
        ...
        Page<Object> actual = embeddedPaginationHelper.fetchPage(QUERY_COUNT_SQL, QUERY_SQL,
                new Object[] {}, 1, 1,
                rowMapper);
    ...
    void testFetchPageLimitWithPluginWithIllegalPageInfo() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> embeddedPaginationHelper.fetchPageLimit(countMapper, queryMapper, 0, 0,
                        null));
        assertThrows(IllegalArgumentException.class,
                () -> embeddedPaginationHelper.fetchPageLimit(countMapper, queryMapper, 1, 0,
                        null));
    }
    ...
    void testFetchPageLimitWithPluginWithoutResult() {
        ...
        when(databaseOperate.queryOne(QUERY_COUNT_SQL, new Object[] {}, Integer.class))
                .thenReturn(null);
        assertThrows(IllegalArgumentException.class,
                () -> embeddedPaginationHelper.fetchPageLimit(countMapper, queryMapper, 1, 1,
                        null));
    }
    ...
    void testFetchPageLimitSimpleWithIllegalPageInfo() {
        assertThrows(IllegalArgumentException.class,
                () -> embeddedPaginationHelper.fetchPageLimit(QUERY_SQL, new Object[] {}, 0, 0,
                        null));
        assertThrows(IllegalArgumentException.class,
                () -> embeddedPaginationHelper.fetchPageLimit(QUERY_SQL, new Object[] {}, 1, 0,
                        null));
    }
    ...
    void testFetchPageLimitSimpleWithData() {
        ...
        when(databaseOperate.queryMany(QUERY_SQL, new Object[] {}, rowMapper))
                .thenReturn(pageItems);
        Page<Object> actual = embeddedPaginationHelper.fetchPageLimit(QUERY_SQL, new Object[] {}, 3,
                1, rowMapper);
