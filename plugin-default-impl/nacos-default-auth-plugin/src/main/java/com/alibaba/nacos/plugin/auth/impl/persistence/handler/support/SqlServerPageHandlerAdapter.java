...
/**
 * SQL Server page handler adapter.
 *
 * @author QY Li
 */
public class SqlServerPageHandlerAdapter implements PageHandlerAdapter {
    ...
    public OffsetFetchResult addOffsetAndFetchNext(String fetchSql, Object[] arg, int pageNo, int pageSize) {
        if (!fetchSql.contains(AuthPageConstant.ORDER_OFFSET_ROWS)) {
            fetchSql += " " + AuthPageConstant.ORDER_OFFSET_ROWS + " " + AuthPageConstant.FETCH_NEXT;
