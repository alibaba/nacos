...
/**
 * vastbase page handler adapter.
 *
 * @author huangKeMing
 */
public class VastBasePageHandlerAdapter implements PageHandlerAdapter {
    
    @Override
    public boolean supports(String dataSourceType) {
        return PersistenceConstant.VASTBASE.equals(dataSourceType);
    }
