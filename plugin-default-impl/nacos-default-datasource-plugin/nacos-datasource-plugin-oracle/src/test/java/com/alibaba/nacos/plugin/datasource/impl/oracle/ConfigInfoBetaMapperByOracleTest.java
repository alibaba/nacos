...
class ConfigInfoBetaMapperByOracleTest {
    ...
    void testUpdateConfigInfo4BetaCas() {
        ...
        assertEquals(sql,
                "UPDATE config_info_beta SET content = ?,md5 = ?,beta_ips = ?,"
                        + "src_ip = ?,src_user = ?,gmt_modified = SYSDATE,app_name = ? "
    ...
    void testFindAllConfigInfoBetaForDumpAllFetchRows() {
        MapperResult result =
                configInfoBetaMapperByOracle.findAllConfigInfoBetaForDumpAllFetchRows(context);
