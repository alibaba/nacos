...
public class ConfigInfoMapperBySqlServer extends AbstractMapperBySqlServer implements ConfigInfoMapper {
    ...
    public MapperResult findChangeConfig(MapperContext context) {
        ...
        String sql =
            "SELECT id, data_id, group_id, tenant_id, app_name,md5, gmt_modified, encrypted_data_key FROM config_info WHERE "
                + "gmt_modified >= ? and id > ? order by id  OFFSET " + startRow + " ROWS FETCH NEXT " + pageSize + " ROWS ONLY ";
    ...
    public MapperResult findConfigInfoBaseLikeFetchRows(MapperContext context) {
        ...
        return new MapperResult(
            sqlFetchRows + where + " ORDER BY id ASC"
    ...
    public MapperResult findConfigInfo4PageFetchRows(MapperContext context) {
        ...
        innerSql.append(" ORDER BY id OFFSET ").append(context.getStartRow()).append(" ROWS FETCH NEXT ")
                .append(context.getPageSize()).append(" ROWS ONLY");
    ...
    public MapperResult findConfigInfoBaseByGroupFetchRows(MapperContext context) {
        String sql =
                "SELECT id,data_id,group_id,content FROM config_info WHERE group_id=? AND tenant_id=?"
                        + " ORDER BY id OFFSET " + context.getStartRow() + " ROWS FETCH NEXT " + context.getPageSize() + " ROWS ONLY";
        return new MapperResult(sql,
