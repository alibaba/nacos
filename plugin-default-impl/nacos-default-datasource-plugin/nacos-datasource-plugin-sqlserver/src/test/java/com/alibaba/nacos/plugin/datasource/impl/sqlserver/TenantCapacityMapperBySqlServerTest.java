...
class TenantCapacityMapperBySqlServerTest {
    ...
    void testIncrementUsageWithDefaultQuotaLimit() {
        MapperResult mapperResult =
            tenantCapacityMapperBySqlServer.incrementUsageWithDefaultQuotaLimit(context);
    ...
    void testIncrementUsageWithQuotaLimit() {
        MapperResult mapperResult =
            tenantCapacityMapperBySqlServer.incrementUsageWithQuotaLimit(context);
        assertEquals(mapperResult.getSql(),
            "UPDATE tenant_capacity SET usage = usage + 1, gmt_modified = ? WHERE tenant_id = ? AND usage < "
                + "quota AND quota != 0");
    ...
    void testGetCapacityList4CorrectUsage() {
        ...
        MapperResult mapperResult =
            tenantCapacityMapperBySqlServer.getCapacityList4CorrectUsage(context);
        assertEquals(
