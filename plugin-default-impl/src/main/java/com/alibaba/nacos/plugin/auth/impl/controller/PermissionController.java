...
public class PermissionController {
    ...
    @Autowired private NacosRoleServiceImpl nacosRoleService;
    ...
    @Secured(
            resource = AuthConstants.CONSOLE_RESOURCE_NAME_PREFIX + "permissions",
    ...
    @Secured(
            resource = AuthConstants.CONSOLE_RESOURCE_NAME_PREFIX + "permissions",
            action = ActionTypes.READ)
    public Page<PermissionInfo> fuzzySearchPermission(
            @RequestParam int pageNo,
            @RequestParam int pageSize,
            @RequestParam(name = "role", defaultValue = StringUtils.EMPTY) String role) {
