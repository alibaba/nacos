...
public class EmbeddedRolePersistServiceImplTest {
    ...
    public void setUp() throws Exception {
        ...
        Class<EmbeddedRolePersistServiceImpl> embeddedRolePersistServiceClass =
                EmbeddedRolePersistServiceImpl.class;
        Field databaseOperateFields =
                embeddedRolePersistServiceClass.getDeclaredField("databaseOperate");
    ...
    public void testGetRolesByUserName() {
        Page<RoleInfo> page =
                embeddedRolePersistService.getRolesByUserNameAndRoleName(
