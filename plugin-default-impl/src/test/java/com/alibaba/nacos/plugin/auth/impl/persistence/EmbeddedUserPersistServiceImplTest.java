...
public class EmbeddedUserPersistServiceImplTest {
    ...
    public void setUp() throws Exception {
        ...
        Class<EmbeddedUserPersistServiceImpl> embeddedUserPersistServiceClass =
                EmbeddedUserPersistServiceImpl.class;

        Field databaseOperateField =
                embeddedUserPersistServiceClass.getDeclaredField("databaseOperate");
