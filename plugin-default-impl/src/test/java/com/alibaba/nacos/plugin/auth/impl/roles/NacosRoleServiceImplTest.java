...
/**
 * NacosRoleServiceImpl Test. @ClassName: NacosRoleServiceImplTest @Author: ChenHao26 @Date:
 * 2022/8/16 17:31 @Description: TODO
 */
...
public class NacosRoleServiceImplTest {
    ...
    @Mock private RolePersistService rolePersistService;

    @Mock private NacosUserDetailsServiceImpl userDetailsService;

    @Mock private PermissionPersistService permissionPersistService;

    @Mock private NacosRoleServiceImpl nacosRoleService;
    ...
    public void setup() throws Exception {
        ...
        Field userDetailsServiceField =
                nacosRoleServiceClass.getDeclaredField("userDetailsService");
        userDetailsServiceField.setAccessible(true);
        userDetailsServiceField.set(nacosRoleService, userDetailsService);

        Field permissionPersistServiceField =
                nacosRoleServiceClass.getDeclaredField("permissionPersistService");
    ...
    public void hasPermission() {
        ...
        Resource resource =
                new Resource(
                        "public", "group", AuthConstants.UPDATE_PASSWORD_ENTRY_POINT, "rw", null);
    ...
    public void getRolesFromDatabase() {
        Page<RoleInfo> roleInfoPage =
                nacosRoleService.getRolesFromDatabase("nacos", "ROLE_ADMIN", 1, Integer.MAX_VALUE);
    ...
    public void getPermissionsByRoleFromDatabase() {
        Page<PermissionInfo> permissionsByRoleFromDatabase =
    ...
    public void getPermissionsFromDatabase() {
        Page<PermissionInfo> permissionsFromDatabase =
                nacosRoleService.getPermissionsFromDatabase("role-admin", 1, Integer.MAX_VALUE);
