...
/**
 * ConfigChangeNotifyInfoTests.
 *
 * @author liyunfei
 */
public class ConfigChangeNotifyInfoTests {
    ...
    public void testBuilder() {
        ...
        ConfigChangeNotifyInfo configChangeNotifyInfo = configChangeNotifyInfoBuilder
                .basicInfo(ConfigChangePointCutTypes.PUBLISH_BY_HTTP.value(), true, TimeUtils.getCurrentTimeStr())
                .build();
