...
package com.alibaba.nacos.plugin.config.impl.util;

import com.alibaba.nacos.plugin.config.impl.NacosFileFormatPluginService;
...
public class NacosFileFormatPluginServiceTests {
    ...
    private String propertiesContent = "#\n" + "# Copyright 1999-2018 Alibaba Group Holding Ltd.\n" + "#\n"
            ...
            + " db.num=1\n" + "\n" + "## Connect URL of DB:\n"
            + " db.url.0=jdbc:mysql://47.98.99.88:3306/nacos_config?characterEncoding=utf8&connectTimeout=1000&socketTimeout=3000&autoReconnect=true&useUnicode=true&useSSL=false&serverTimezone=UTC\n"
            ...
            + "# dingTalk\n"
            + "nacos.core.config.plugin.webhook.url=https://oapi.dingtalk.com/robot/send?access_token=a5ddc8240703732ed2fd02224864b80c30ab6270bdf42da1c9299efc1567d789\n"
            + "\n" + "# https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=19d192c9-07fc-4b1f-ad2e-5549ef4f939e\n"
            + "# https://oapi.dingtalk.com/robot/send?access_token=a5ddc8240703732ed2fd02224864b80c30ab6270bdf42da1c9299efc1567d789\n"
            + "\n" + "spring.message.enable=true\n"
            + "spring.message.wechat-webhooks=https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=19d192c9-07fc-4b1f-ad2e-5549ef4f939e\n"
