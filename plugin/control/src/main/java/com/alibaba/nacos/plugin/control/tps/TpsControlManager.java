    ...
    protected void initTpsRule(String pointName) {
        ...
        if (StringUtils.isNotBlank(localRuleContent)) {
            Loggers.CONTROL.info(
                    "Found local disk tps control rule of {},content ={}",
                    pointName,
                    localRuleContent);
            ...
            if (StringUtils.isNotBlank(localRuleContent)) {
                Loggers.CONTROL.info(
                        "Found external  tps control rule of {},content ={}",
                        pointName,
                        localRuleContent);
            }
        }
        ...
        if (StringUtils.isNotBlank(localRuleContent)) {
            TpsControlRule tpsLimitRule =
                    RuleParserProxy.getInstance().parseTpsRule(localRuleContent);
