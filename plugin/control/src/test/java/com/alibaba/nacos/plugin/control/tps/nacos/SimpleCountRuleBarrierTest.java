...
public class SimpleCountRuleBarrierTest {
    
    
    @Test
    public void testPassAndLimit() {
        SimpleCountRuleBarrier ruleBarrier = new SimpleCountRuleBarrier("test", "test:simple123*", TimeUnit.SECONDS);
    ...
    public void testLimitAndRollback() {
        SimpleCountRuleBarrier ruleBarrier = (SimpleCountRuleBarrier) SimpleCountRuleBarrierCreator.getInstance()
                .createRuleBarrier("test", "test:simple123*", TimeUnit.SECONDS);
        ruleBarrier.setMaxCount(10);
        ruleBarrier.setModel(MODEL_PROTO);
        ruleBarrier.setMonitorType(MonitorType.INTERCEPT.getType());
