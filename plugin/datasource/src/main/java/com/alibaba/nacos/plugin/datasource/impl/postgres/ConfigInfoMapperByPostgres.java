...
public class ConfigInfoMapperByPostgres extends AbstractMapper implements ConfigInfoMapper {
    ...
    public String getTenantIdList(int startRow, int pageSize) {
        return "SELECT tenant_id FROM config_info WHERE tenant_id != '' GROUP BY tenant_id LIMIT " + pageSize + " OFFSET "
                + startRow;
    }
