...
public class GroupCapacityMapperByDerbyTest {
    ...
    public void testInsertIntoSelect() {
        ...
        Assert.assertArrayEquals(
                ...
                new Object[] {
                    group, quota, maxSize, maxAggrCount, maxAggrSize, createTime, modified
                });
    }
    ...
    public void testInsertIntoSelectByWhere() {
        ...
        Assert.assertArrayEquals(
                mapperResult.getParamList().toArray(),
                new Object[] {
                    group, quota, maxSize, maxAggrCount, maxAggrSize, createTime, modified, group
                });
    }
    ...
    public void testIncrementUsageByWhereQuotaEqualZero() {
        ...
        MapperResult mapperResult =
                groupCapacityMapperByDerby.incrementUsageByWhereQuotaEqualZero(context);
        Assert.assertEquals(
                mapperResult.getSql(),
                "UPDATE group_capacity SET usage = usage + 1, gmt_modified = ? WHERE group_id = ? AND usage < ? AND quota = 0");
        Assert.assertArrayEquals(
                mapperResult.getParamList().toArray(), new Object[] {modified, groupId, usage});
    }
    ...
    public void testIncrementUsageByWhereQuotaNotEqualZero() {
        ...
        MapperResult mapperResult =
                groupCapacityMapperByDerby.incrementUsageByWhereQuotaNotEqualZero(context);
        Assert.assertEquals(
                mapperResult.getSql(),
                "UPDATE group_capacity SET usage = usage + 1, gmt_modified = ? WHERE group_id = ? AND usage < quota AND quota != 0");
        Assert.assertArrayEquals(
                mapperResult.getParamList().toArray(), new Object[] {modified, groupId});
    }
    ...
    public void testUpdateUsageByWhere() {
        ...
        Assert.assertArrayEquals(
                mapperResult.getParamList().toArray(), new Object[] {groupId, modified, groupId});
    }
    ...
    public void testSelectGroupInfoBySize() {
        ...
        Assert.assertArrayEquals(
                mapperResult.getParamList().toArray(), new Object[] {id, pageSize});
    }
}
