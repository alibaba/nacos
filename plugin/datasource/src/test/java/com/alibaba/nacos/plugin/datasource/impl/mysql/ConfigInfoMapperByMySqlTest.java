...
public class ConfigInfoMapperByMySqlTest {
    ...
    public void testFindAllDataIdAndGroup() {
        ...
        Assert.assertEquals(
                mapperResult.getSql(), "SELECT DISTINCT data_id, group_id FROM config_info");
    ...
    public void testFindConfigInfoByAppCountRows() {
        ...
        Assert.assertArrayEquals(
                mapperResult.getParamList().toArray(), new Object[] {tenantId, appName});
    }
    ...
    public void testConfigInfoLikeTenantCount() {
        ...
        Assert.assertEquals(
                mapperResult.getSql(), "SELECT count(*) FROM config_info WHERE tenant_id LIKE ?");
    ...
    public void testFindChangeConfig() {
        ...
        Assert.assertArrayEquals(
                ...
                new Object[] {startTime, lastMaxId, pageSize});
    }
    ...
    public void testFindChangeConfigCountRows() {
        ...
        Assert.assertArrayEquals(
                mapperResult.getParamList().toArray(), new Object[] {appName, startTime, endTime});
    }
    ...
    public void testFindConfigInfoBaseLikeCountRows() {
        ...
        Assert.assertEquals(
                mapperResult.getSql(),
                "SELECT count(*) FROM config_info WHERE  1=1 AND tenant_id='' ");
        Assert.assertArrayEquals(mapperResult.getParamList().toArray(), emptyObjs);
    }
    ...
    public void testFindConfigInfo4PageFetchRows() {
        ...
        Assert.assertEquals(
                ...
                "SELECT id,data_id,group_id,tenant_id,app_name,content,type,encrypted_data_key FROM config_info"
                        + " WHERE  tenant_id=?  AND app_name=?  LIMIT "
                        + startRow
                        + ","
                        + pageSize);
        Assert.assertArrayEquals(
    ...
    public void testFindConfigInfoBaseByGroupFetchRows() {
        ...
        Assert.assertEquals(
                ...
                "SELECT id,data_id,group_id,content FROM config_info WHERE group_id=? AND tenant_id=? LIMIT "
                        ...
                        + pageSize);
        Assert.assertArrayEquals(
                mapperResult.getParamList().toArray(), new Object[] {groupId, tenantId});
    }
    ...
    public void testFindConfigInfoLike4PageFetchRows() {
        ...
        Assert.assertEquals(
                ...
                "SELECT id,data_id,group_id,tenant_id,app_name,content,encrypted_data_key FROM config_info "
                        + "WHERE  tenant_id LIKE ?  AND app_name = ?  LIMIT "
                        + startRow
                        + ","
                        + pageSize);
        Assert.assertArrayEquals(
    ...
    public void testFindAllConfigInfoFetchRows() {
        ...
        Assert.assertArrayEquals(
                mapperResult.getParamList().toArray(), new Object[] {tenantId, startRow, pageSize});
    }
    ...
    public void testRemoveConfigInfoByIdsAtomic() {
        ...
        Assert.assertEquals(
                mapperResult.getSql(), "DELETE FROM config_info WHERE id IN (?, ?, ?, ?, ?) ");
        Assert.assertArrayEquals(mapperResult.getParamList().toArray(), ids.toArray());
    }
