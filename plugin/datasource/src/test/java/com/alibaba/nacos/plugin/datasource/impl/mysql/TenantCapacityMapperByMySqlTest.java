...
public class TenantCapacityMapperByMySqlTest {
    ...
    public void testIncrementUsageWithDefaultQuotaLimit() {
        MapperResult mapperResult =
                tenantCapacityMapperByMySql.incrementUsageWithDefaultQuotaLimit(context);
        Assert.assertEquals(
                mapperResult.getSql(),
    ...
    public void testIncrementUsageWithQuotaLimit() {
        MapperResult mapperResult =
                tenantCapacityMapperByMySql.incrementUsageWithQuotaLimit(context);
        Assert.assertEquals(
                mapperResult.getSql(),
                "UPDATE tenant_capacity SET usage = usage + 1, gmt_modified = ? WHERE tenant_id = ? AND usage < "
                        + "quota AND quota != 0");
    ...
    public void testGetCapacityList4CorrectUsage() {
        ...
        MapperResult mapperResult =
                tenantCapacityMapperByMySql.getCapacityList4CorrectUsage(context);
        Assert.assertEquals(
                mapperResult.getSql(),
