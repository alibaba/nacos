...
public class ConfigInfoMapperByPostgresTest {
    
    private ConfigInfoMapperByPostgres configInfoMapperByPostgres;
    
    @Before
    public void setUp() throws Exception {
        configInfoMapperByPostgres = new ConfigInfoMapperByPostgres();
    }
    
    @Test
    public void testFindConfigMaxId() {
        String sql = configInfoMapperByPostgres.findConfigMaxId();
        Assert.assertEquals(sql, "SELECT MAX(id) FROM config_info");
    }
    
    @Test
    public void testFindAllDataIdAndGroup() {
        String sql = configInfoMapperByPostgres.findAllDataIdAndGroup();
        Assert.assertEquals(sql, "SELECT DISTINCT data_id, group_id FROM config_info");
    }
    
    @Test
    public void testFindConfigInfoByAppCountRows() {
        String sql = configInfoMapperByPostgres.findConfigInfoByAppCountRows();
    ...
    public void testFindConfigInfoByAppFetchRows() {
        String sql = configInfoMapperByPostgres.findConfigInfoByAppFetchRows(0, 5);
    ...
    public void testConfigInfoLikeTenantCount() {
        String sql = configInfoMapperByPostgres.configInfoLikeTenantCount();
        Assert.assertEquals(sql, "SELECT count(*) FROM config_info WHERE tenant_id LIKE ?");
    }
    
    @Test
    public void testGetTenantIdList() {
        String sql = configInfoMapperByPostgres.getTenantIdList(0, 5);
        Assert.assertEquals(sql,
                "SELECT tenant_id FROM config_info WHERE tenant_id != '' GROUP BY tenant_id LIMIT 5 OFFSET 0");
    }
    
    @Test
    public void testGetGroupIdList() {
        String sql = configInfoMapperByPostgres.getGroupIdList(0, 5);
    ...
    public void testFindAllConfigKey() {
        String sql = configInfoMapperByPostgres.findAllConfigKey(0, 5);
    ...
    public void testFindAllConfigInfoBaseFetchRows() {
        String sql = configInfoMapperByPostgres.findAllConfigInfoBaseFetchRows(0, 5);
        Assert.assertEquals(sql,
                "SELECT t.id,data_id,group_id,content,md5 FROM ( SELECT id FROM config_info ORDER BY id LIMIT ? OFFSET ?"
                        + "  )  g, config_info t  WHERE g.id = t.id ");
    }
    
    @Test
    public void testFindAllConfigInfoFragment() {
        String sql = configInfoMapperByPostgres.findAllConfigInfoFragment(0, 5);
        Assert.assertEquals(sql,
    ...
    public void testFindChangeConfig() {
        String sql = configInfoMapperByPostgres.findChangeConfig();
        Assert.assertEquals(sql,
    ...
    public void testFindChangeConfigCountRows() {
        ...
        String sql = configInfoMapperByPostgres.findChangeConfigCountRows(new HashMap<>(), timestamp, timestamp);
        Assert.assertEquals(sql,
    ...
    public void testFindChangeConfigFetchRows() {
        Timestamp timestamp = new Timestamp(System.currentTimeMillis());
        String sql = configInfoMapperByPostgres.findChangeConfigFetchRows(new HashMap<>(), timestamp, timestamp, 0, 5,
                100);
        Assert.assertEquals(sql,
    ...
    public void testListGroupKeyMd5ByPageFetchRows() {
        String sql = configInfoMapperByPostgres.listGroupKeyMd5ByPageFetchRows(0, 5);
        Assert.assertEquals(sql,
    ...
    public void testFindAllConfigInfo4Export() {
        String sql = configInfoMapperByPostgres.findAllConfigInfo4Export(new ArrayList<>(), new HashMap<>());
        Assert.assertEquals(sql,
    ...
    public void testFindConfigInfoBaseLikeCountRows() {
        String sql = configInfoMapperByPostgres.findConfigInfoBaseLikeCountRows(new HashMap<>());
    ...
    public void testFindConfigInfoBaseLikeFetchRows() {
        String sql = configInfoMapperByPostgres.findConfigInfoBaseLikeFetchRows(new HashMap<>(), 0, 5);
        Assert.assertEquals(sql,
    ...
    public void testFindConfigInfo4PageCountRows() {
        String sql = configInfoMapperByPostgres.findConfigInfo4PageCountRows(new HashMap<>());
        Assert.assertEquals(sql, "SELECT count(*) FROM config_info WHERE  tenant_id=? ");
    }
    
    @Test
    public void testFindConfigInfo4PageFetchRows() {
        String sql = configInfoMapperByPostgres.findConfigInfo4PageFetchRows(new HashMap<>(), 0, 5);
        Assert.assertEquals(sql,
    ...
    public void testFindConfigInfoBaseByGroupFetchRows() {
        String sql = configInfoMapperByPostgres.findConfigInfoBaseByGroupFetchRows(0, 5);
        Assert.assertEquals(sql,
    ...
    public void testFindConfigInfoLike4PageCountRows() {
        String sql = configInfoMapperByPostgres.findConfigInfoLike4PageCountRows(new HashMap<>());
        Assert.assertEquals(sql, "SELECT count(*) FROM config_info WHERE  tenant_id LIKE ? ");
    }
    
    @Test
    public void testFindConfigInfoLike4PageFetchRows() {
        String sql = configInfoMapperByPostgres.findConfigInfoLike4PageFetchRows(new HashMap<>(), 0, 5);
        Assert.assertEquals(sql,
    ...
    public void testFindAllConfigInfoFetchRows() {
        String sql = configInfoMapperByPostgres.findAllConfigInfoFetchRows(0, 5);
        Assert.assertEquals(sql,
    ...
    public void testFindConfigInfosByIds() {
        String sql = configInfoMapperByPostgres.findConfigInfosByIds(5);
        Assert.assertEquals(sql,
    ...
    public void testRemoveConfigInfoByIdsAtomic() {
        String sql = configInfoMapperByPostgres.removeConfigInfoByIdsAtomic(5);
        Assert.assertEquals(sql, "DELETE FROM config_info WHERE id IN (?, ?, ?, ?, ?) ");
    }
    
    @Test
    public void testGetTableName() {
        String sql = configInfoMapperByPostgres.getTableName();
        Assert.assertEquals(sql, TableConstant.CONFIG_INFO);
    }
    
    @Test
    public void testGetDataSource() {
        String sql = configInfoMapperByPostgres.getDataSource();
        Assert.assertEquals(sql, DataSourceConstant.POSTGRES);
    }
    
    @Test
    public void testUpdateConfigInfoAtomicCas() {
        String sql = configInfoMapperByPostgres.updateConfigInfoAtomicCas();
