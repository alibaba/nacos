...
public class HistoryConfigInfoMapperByPostgresTest {
    
    private HistoryConfigInfoMapperByPostgres historyConfigInfoMapperByPostgres;
    
    @Before
    public void setUp() throws Exception {
        historyConfigInfoMapperByPostgres = new HistoryConfigInfoMapperByPostgres();
    }
    
    @Test
    public void testRemoveConfigHistory() {
        String sql = historyConfigInfoMapperByPostgres.removeConfigHistory();
        Assert.assertEquals(sql, "DELETE FROM his_config_info WHERE gmt_modified < ? LIMIT ?");
    }
    
    @Test
    public void testFindConfigHistoryCountByTime() {
        String sql = historyConfigInfoMapperByPostgres.findConfigHistoryCountByTime();
        Assert.assertEquals(sql, "SELECT count(*) FROM his_config_info WHERE gmt_modified < ?");
    }
    
    @Test
    public void testFindDeletedConfig() {
        String sql = historyConfigInfoMapperByPostgres.findDeletedConfig();
    ...
    public void testFindConfigHistoryFetchRows() {
        String sql = historyConfigInfoMapperByPostgres.findConfigHistoryFetchRows();
        Assert.assertEquals(sql,
    ...
    public void testDetailPreviousConfigHistory() {
        String sql = historyConfigInfoMapperByPostgres.detailPreviousConfigHistory();
        Assert.assertEquals(sql,
    ...
    public void testGetTableName() {
        String tableName = historyConfigInfoMapperByPostgres.getTableName();
        Assert.assertEquals(tableName, TableConstant.HIS_CONFIG_INFO);
    }
    
    @Test
    public void testGetDataSource() {
        String dataSource = historyConfigInfoMapperByPostgres.getDataSource();
