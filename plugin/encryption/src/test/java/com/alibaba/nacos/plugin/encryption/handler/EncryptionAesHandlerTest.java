...
public class EncryptionAesHandlerTest {
    ...
    public void testEncrypt() {
        ...
        Assert.assertEquals("should return the encryption secret key if algorithm defined.",
                mockEncryptionPluginService.encryptSecretKey(contentKey), pair.getFirst());
        Assert.assertEquals("should return the encryption content if algorithm defined.",
                mockEncryptionPluginService.encrypt(contentKey, content), pair.getSecond());
    }
    ...
    public void testDecrypt() {
        ...
        Pair<String, String> pair = EncryptionHandler.decryptHandler("cipher-aes-dataId", encryptionSecretKey,
                encryptionContent);

        Assert.assertEquals("should return the original secret key if algorithm defined.",
                mockEncryptionPluginService.generateSecretKey(), pair.getFirst());
    ...
    public void testEncryptAndDecrypt() {
        ...
        Assert.assertEquals("should return the encryption secret key if algorithm defined.",
                mockEncryptionPluginService.encryptSecretKey(contentKey), encryptionSecretKey);
        Assert.assertEquals("should return the encryption content if algorithm defined.",
                mockEncryptionPluginService.encrypt(contentKey, content), encryptionContent);

        Pair<String, String> decryptPair = EncryptionHandler.decryptHandler(dataId, encryptionSecretKey,
                encryptionContent);
        Assert.assertNotNull(decryptPair);
        Assert.assertEquals("should return the original secret key if algorithm defined.",
                mockEncryptionPluginService.generateSecretKey(), decryptPair.getFirst());
        Assert.assertEquals("should return the original content if algorithm defined.",
                content, decryptPair.getSecond());
    }
