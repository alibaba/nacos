...
public class PrometheusController {
     ...
     */
    @GetMapping(
            value = ApiConstants.PROMETHEUS_CONTROLLER_PATH,
        ...
        for (String namespace : allNamespaces) {
            ...
            for (Service service : singletons) {
                ...
                List<? extends Instance> instances =
                        instanceServiceV2.listAllInstances(
     ...
     */
    @GetMapping(
            value = ApiConstants.PROMETHEUS_CONTROLLER_NAMESPACE_PATH,
            produces = "application/json; charset=UTF-8")
     ...
     */
    @GetMapping(
            value = ApiConstants.PROMETHEUS_CONTROLLER_SERVICE_PATH,
            produces = "application/json; charset=UTF-8")
