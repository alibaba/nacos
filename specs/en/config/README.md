...
These specs define the Nacos Config domain from the domain boundary down to
specific behavior.

## Domain Foundation

- [Config Spec](config-spec.md)
...
- [Config Change Plugin Spec](../plugin/config-change-plugin-spec.md)
