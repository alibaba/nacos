...
CREATE INDEX configinfo_dataid_key_idx ON config_info_draft(data_id);
CREATE INDEX configinfo_groupid_key_idx ON config_info_draft(group_id);
CREATE INDEX configinfo_dataid_group_key_idx ON config_info_draft(data_id, group_id);
