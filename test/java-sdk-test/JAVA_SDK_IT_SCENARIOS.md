...
2. AI residual expansion: all-version MCP endpoint behavior, missing MCP/A2A
   endpoint behavior, A2A endpoint TLS/query boundaries, unsubscribe-stop
   behavior, and functional Prompt/Skill/AgentSpec resource creation or explicit
