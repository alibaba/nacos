...
1. Fuzzy watch expansion for Config and Naming once the standalone server path
   and event timing are proven stable.
2. AI residual expansion: MCP unsubscribe-stop behavior, missing A2A endpoint
