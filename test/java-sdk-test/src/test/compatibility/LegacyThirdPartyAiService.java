...
/**
 * Third-party implementation compiled only against the released 3.2.4 API.
 *
 * @author xiweng.yy
 */
public class LegacyThirdPartyAiService implements AiService {
    ...
    public McpServerDetailInfo getMcpServer(String mcpName, String version) throws NacosException {
        ...
        result.setName(mcpName + ":" + version);
        return result;
    }
    ...
    public AgentCardDetailInfo getAgentCard(String agentName, String version,
        ...
        result.setName(agentName + ":" + version + ":" + registrationType);
        return result;
    }
